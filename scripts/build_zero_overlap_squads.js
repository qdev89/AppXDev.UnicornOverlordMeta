...
const ZERO_OVERLAP_SQUADS = [
  {
    ...
    keyItems: ['Holy Unicorn Blade', 'Ring of the Unicorn', 'Chloe\'s Charm (Keen Earring)', 'Heavensteed Reins'],
    ...
    counters: ['Heavy Anti-Cavalry Flying Squads', 'Start-of-Battle Dispel'],
    strategyGuide: {
    ...
    unitGearConfigs: [
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Kingsblade Cornix', 'Notos\'s Sword', 'Meteorite Sword'],
          slotType: 'Weapon',
          notes: 'Phys Atk +28, All Stats +5, AP +1'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Greatshield of the Maiden',
          optimalAlternatives: ['Azure Crest Shield', 'Silver Shield', 'Knight Shield'],
          slotType: 'Shield',
          notes: 'Phys Def +16, Guard Rate +40%, Quick Cover'
        },
        slot3Accessory: {
          bestInSlot: 'Ring of the Unicorn',
          optimalAlternatives: ['Holy Unicorn Signet', 'Hero\'s Medallion', 'Lionheart'],
          slotType: 'Accessory',
          notes: 'All Stats +5, AP +1, PP +1, Affliction Immunity'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Warrior\'s Medallion', 'Amethyst Pendant'],
          slotType: 'Accessory',
          notes: 'AP +1 for extra Spinning Edge executions'
        },
        statPriorities: ['Phys Atk (S+)', 'Phys Def (S)', 'Initiative (A)'],
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Notos\'s Sword', 'Meteorite Sword', 'Keen Broadsword'],
          slotType: 'Weapon',
          notes: 'Phys Atk +28, All Stats +5'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Parrying Dagger (Second Blade)',
          optimalAlternatives: ['Pursuant\'s Blade', 'Carnelian Blade', 'Steel Blade'],
          slotType: 'Offhand',
          notes: 'Dual-Wield Slot: Evasion +15, Parrying Slash'
        },
        slot3Accessory: {
          bestInSlot: 'Parrying Amulet',
          optimalAlternatives: ['Lucky Coin', 'Thief\'s Mantle', 'Skillful Amulet'],
          slotType: 'Accessory',
          notes: 'Parrying Slash: Negates physical melee and counters'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Critical Ring', 'Skillful Amulet'],
          slotType: 'Accessory',
          notes: 'AP +1 for Meteor Slash flurries'
        },
        statPriorities: ['Crit Rate (S+)', 'Initiative (S)', 'Phys Atk (A)'],
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Sacral Rod', 'Meteorite Rod', 'Kingstaff Albiore'],
          slotType: 'Weapon',
          notes: 'Mag Atk +24, HP Regen +10%'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Scarlett\'s Ribbon',
          optimalAlternatives: ['Archbishop\'s Mitre', 'Monk\'s Mitre', 'Priestess Ribbon'],
          slotType: 'Helm',
          notes: 'Healing +20, Mag Def +8, PP +1'
        },
        slot3Accessory: {
          bestInSlot: 'Ring of the Maiden',
          optimalAlternatives: ['Holy Broach', 'Celestial Talisman', 'Lifeblood Talisman'],
          slotType: 'Accessory',
          notes: 'Mag Def +10, AP +1, PP +1, Maiden\'s Protection'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'First Aid Kit', 'Dove Plume'],
          slotType: 'Accessory',
          notes: 'PP +1 for Passive Supply and Holy Light'
        },
        statPriorities: ['Healing (S+)', 'Mag Def (S)', 'Initiative (A)'],
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Meteorite Lance', 'Kingslance Elhal', 'Heavy Iron Lance'],
          slotType: 'Weapon',
          notes: 'Phys Atk +25, AP +1'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Knight Shield',
          optimalAlternatives: ['Silver Shield', 'Azure Crest Shield', 'Cloth Gauntlets'],
          slotType: 'Shield',
        ...
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Warrior\'s Medallion', 'Power Belt'],
          slotType: 'Accessory',
          notes: 'AP +1 for Line Charge chaining'
        },
        statPriorities: ['Phys Atk (S+)', 'Initiative (A)', 'Guard Rate (B)'],
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Runic Spear', 'Iron Spear', 'Carnelian Spear'],
          slotType: 'Weapon',
          notes: 'Phys Atk +24, Max HP +20'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Silver Shield',
          optimalAlternatives: ['Knight Shield', 'Cloth Gauntlets', 'Bronze Shield'],
          slotType: 'Shield',
          notes: 'Phys Def +11, Guard Rate +25%'
        },
        slot3Accessory: {
          bestInSlot: 'Chloe\'s Charm (Keen Earring)',
          optimalAlternatives: ['Lapis Pendant', 'Retaliation Earrings', 'Skillful Amulet'],
          slotType: 'Accessory',
          notes: 'Keen Call: Grants 100% Guaranteed Crit to Alain / Clive'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Dove Plume', 'First Aid Kit'],
          slotType: 'Accessory',
          notes: 'PP +1 to sustain Keen Call activations'
        },
        statPriorities: ['PP (+4 Required)', 'Initiative (A)', 'Phys Atk (B)'],
        growthTypes: ['Speedster', 'Keen']
      }
    ],
    tacticsSequence: [
      { step: 1, unit: 'Scarlett', skill: 'Sacred Light', condition1: '[Start of Battle]', condition2: '[Full Squad]', notes: 'Squad HP regen & affliction immunity' },
      { step: 2, unit: 'Chloe', skill: 'Keen Call', condition1: '[Ally Active Attack]', condition2: '[Target: Alain]', notes: 'Grants 100% Guaranteed Critical Hit' },
      { step: 3, unit: 'Alain', skill: 'Spinning Edge', condition1: '[Front Row Enemies >= 2]', condition2: '[Self AP >= 2]', notes: '100% Crit Row Wipe strike' },
      { step: 4, unit: 'Clive', skill: 'Line Charge', condition1: '[Target Column/Row]', condition2: '[Self AP >= 2]', notes: '200% bonus vs infantry' },
      { step: 5, unit: 'Melisandre', skill: 'Parrying Slash', condition1: '[Attacked by Physical]', condition2: '[Self PP >= 1]', notes: 'Negates damage & counters' }
    ],
    substitutes: { earlyGame: ['Lex Vanguard', 'Josef Paladin'], endgameAlternatives: ['Monica Sainted Knight replacing Chloe'] }
  },
  {
    ...
    unitGearConfigs: [
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Euros\'s Staff', 'Carnelian Staff', 'Kingstaff Albiore'],
          slotType: 'Weapon',
          notes: 'Trinity Rain 4 AP, Mag Atk +25, Mag Def +8'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Sage\'s Hood',
          optimalAlternatives: ['Silk Hood', 'Mage\'s Gloves', 'Ancient Crown'],
          slotType: 'Helm',
          notes: 'Mag Atk +5, Mag Def +5, Initiative +4'
        },
        slot3Accessory: {
          bestInSlot: 'Sniper\'s Amber Lens',
          optimalAlternatives: ['Sniper\'s Lens', 'Sorcerer\'s Medallion', 'Magia Heart'],
          slotType: 'Accessory',
          notes: 'Eagle Eye: Guaranteed 100% Crit + True Strike'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Amethyst Pendant', 'Raven Plume'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Meteorite Rod', 'Sacral Rod', 'Hallow Cane'],
          slotType: 'Weapon',
        ...
        slot3Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Amethyst Pendant', 'Onyx Pendant'],
          slotType: 'Accessory',
          notes: 'PP +1 required for Quick Impetus (3 PP)'
        },
        slot4Accessory: {
          bestInSlot: 'Sapphire Pendant',
          optimalAlternatives: ['Lapis Pendant', 'Onyx Pendant', 'Dove Plume'],
          slotType: 'Accessory',
          notes: 'PP +2 ensuring total PP >= 4'
        },
        statPriorities: ['PP (+4 Required)', 'Initiative (A)', 'Healing (S)'],
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Meteorite Rod', 'Runic Rod', 'Chlorotic'],
          slotType: 'Weapon',
          notes: 'Mag Atk +25, AP +1'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Silk Hood',
          optimalAlternatives: ['Sage\'s Hood', 'Dusk Robes', 'Dawn Robes'],
          slotType: 'Helm',
          notes: 'Mag Def +4, Initiative +3'
        },
        slot3Accessory: {
          bestInSlot: 'Familiar\'s Choker',
          optimalAlternatives: ['Magia Heart', 'Magia Soul', 'Sorcerer\'s Medallion'],
          slotType: 'Accessory',
          notes: 'Sorcerous Connection: +50% Magic Attack to Auch'
        },
        slot4Accessory: {
          bestInSlot: 'Raven Plume',
          optimalAlternatives: ['Dove Plume', 'Carnelian Pendant', 'Lapis Pendant'],
          slotType: 'Accessory',
          notes: 'Initiative +15 to buff Auch before cast'
        },
        statPriorities: ['Initiative (S+)', 'Mag Atk (A)', 'PP +2'],
      ...
      },
      {
        ...
        slot1Weapon: {
          bestInSlot: 'Meteorite Lance',
          optimalAlternatives: ['Heavy Iron Lance', 'Bronze Spear', 'Carnelian Spear'],
          slotType: 'Weapon',
          notes: 'Phys Atk +24, Max HP +20'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Greatshield of Fortitude',
          optimalAlternatives: ['Heavy Guard Shield', 'Tower Shield', 'Azure Crest Shield'],
          slotType: 'Shield',
          notes: 'Phys Def +18, Guard Rate +45%, Max HP +20'
        },
        slot3Accessory: {
          bestInSlot: 'Defensive Ring',
          optimalAlternatives: ['Guardian Gloves', 'Vitality Talisman', 'Defender\'s Ring'],
          slotType: 'Accessory',
          notes: 'Phys Def +5, Guard Rate +10%'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Heavy Guard Ring', 'Vitality Talisman'],
          slotType: 'Accessory',
          notes: 'PP +1 for Heavy Cover activations'
        },
        statPriorities: ['Phys Def (S+)', 'Guard Rate (100%)', 'Max HP (S)'],
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Pestilent Staff', 'Poison Hex Staff', 'Euros\'s Staff'],
          slotType: 'Weapon',
          notes: 'Sandstorm: Start of Battle Blindness'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Druid\'s Robes',
          optimalAlternatives: ['Dusk Robes', 'Silk Hood', 'Sage\'s Hood'],
          slotType: 'Helm',
          notes: 'Mag Def +10, Initiative +6, Debuff Resistance +50%'
        },
        slot3Accessory: {
          bestInSlot: 'Raven Plume',
          optimalAlternatives: ['Angel Plume', 'Dove Plume', 'Thief\'s Mantle'],
          slotType: 'Accessory',
          notes: 'Initiative +15 to ensure Turn-0 curse application'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Amethyst Pendant', 'First Aid Kit'],
          slotType: 'Accessory',
          notes: 'PP +1 for Defensive Curse and Quick Guard'
        },
        statPriorities: ['Initiative (S+)', 'Debuff Potency (S)', 'Evasion (A)'],
        growthTypes: ['Speedster', 'Guardian']
      }
    ],
    tacticsSequence: [
      { step: 1, unit: 'Selvie', skill: 'Sandstorm', condition1: '[Start of Battle]', condition2: '[All Enemies]', notes: 'Blinds enemy attackers on Turn 0' },
      { step: 2, unit: 'Selvie', skill: 'Defensive Curse', condition1: '[Front Row Enemies]', condition2: '[Self AP >= 1]', notes: 'Cuts enemy M.Def by 50%' },
      { step: 3, unit: 'Auch', skill: 'Trinity Rain', condition1: '[Target: All Enemies]', condition2: '[Self AP >= 4]', notes: 'Channels 3-wave battlefield magic spell' },
      { step: 4, unit: 'Sharon', skill: 'Quick Impetus', condition1: '[Ally Using Charge Skill]', condition2: '[Target: Auch]', notes: 'Cat-Ear Hood instant turn execution' },
      { step: 5, unit: 'Yahna', skill: 'Sorcerous Connection', condition1: '[Ally Using Active Magic]', condition2: '[Target: Auch]', notes: '+50% Magic Attack boost' },
      { step: 6, unit: 'Auch', skill: 'Eagle Eye', condition1: '[Before Trinity Rain Hits]', condition2: '[Self PP >= 1]', notes: '100% Critical True-Strike wipe' }
    ],
    substitutes: { earlyGame: ['Wizard Auch', 'Cleric Sharon', 'Hoplite Hodrick'], endgameAlternatives: ['Rosalinde replacing Yahna'] }
  },
  {
    ...
    keyItems: ['Dragoon\'s War Spear', 'White Cat-Ear Hood', 'Angel Plume', 'Wingline Standard'],
    ...
    counters: ['Sniper Aerial Snipe True-Strike', 'Anti-Flying Balistas'],
    strategyGuide: {
    ...
    unitGearConfigs: [
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Kingslance Elhal', 'Meteorite Lance', 'Runic Spear'],
          slotType: 'Weapon',
          notes: 'Dragoon Dive 4 AP, Phys Atk +24, Initiative +5'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Wyvern Reins',
          optimalAlternatives: ['Heavenwyvern Reins', 'Wyvern Claw', 'Silver Shield'],
          slotType: 'Shield',
          notes: 'Flying Atk +10%, Initiative +5'
        },
        slot3Accessory: {
          bestInSlot: 'Sniper\'s Amber Lens',
          optimalAlternatives: ['Sniper\'s Lens', 'Hero\'s Medallion', 'Warrior\'s Medallion'],
          slotType: 'Accessory',
          notes: 'Eagle Eye: Guaranteed 100% Crit + True Strike'
        },
        slot4Accessory: {
        ...
        statPriorities: ['Phys Atk (S+)', 'Initiative (A)', 'Crit Rate (A)'],
        growthTypes: ['Offensive', 'Keen']
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Meteorite Axe', 'Carnat Axe', 'Dragonbone Axe'],
          slotType: 'Weapon',
          notes: 'Phys Atk +26, Initiative +5, Crit +10%'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Heavenwyvern Reins',
          optimalAlternatives: ['Gryphon Shield', 'Wyvern Reins', 'Silver Shield'],
          slotType: 'Shield',
          notes: 'Flying Atk +15%, Initiative +10'
        },
        slot3Accessory: {
          bestInSlot: 'Wingline Standard',
          optimalAlternatives: ['Battleline Standard', 'Elite Standard', 'Gryphon Brooch'],
          slotType: 'Accessory',
          notes: 'Squad Flying Atk +15%, Initiative +5'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Raven Plume', 'Warrior\'s Medallion'],
          slotType: 'Accessory',
          notes: 'AP +1 for High Gale row sweeps'
        },
        statPriorities: ['Phys Atk (S)', 'Initiative (S)', 'Evasion (A)'],
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Phantom Knight\'s Sword', 'Notos\'s Sword', 'Hallowed Blade'],
          slotType: 'Weapon',
          notes: 'Phys Atk +18, Mag Atk +24, Magick Attack'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Radiant Shield',
          optimalAlternatives: ['Silver Shield', 'Azure Crest Shield', 'Knight Shield'],
          slotType: 'Shield',
          notes: 'Phys Def +12, Mag Def +12, Magic Barrier'
        },
        slot3Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'White Knight Plume', 'Amethyst Pendant'],
          slotType: 'Accessory',
          notes: 'PP +1 for Magic Barrier triggers'
        },
        slot4Accessory: {
          bestInSlot: 'First Aid Kit',
          optimalAlternatives: ['Large Aid Kit', 'Lapis Pendant', 'Vitality Talisman'],
          slotType: 'Accessory',
          notes: 'End of battle squad heal sustain'
        },
        statPriorities: ['Mag Def (S+)', 'Healing (S)', 'Phys Def (B)'],
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Meteorite Rod', 'Hallowed Mace', 'Euros\'s Staff'],
          slotType: 'Weapon',
          notes: 'Mag Atk +25, HP +15'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'White Cat-Ear Hood',
          optimalAlternatives: ['Cat-Ear Hood', 'Archbishop\'s Mitre', 'Silk Hood'],
          slotType: 'Helm',
          notes: 'Quick Impetus: +100% Turn Bar to Hilda, PP +1'
        },
        slot3Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Amethyst Pendant', 'Dove Plume'],
          slotType: 'Accessory',
          notes: 'PP +1 required for Quick Impetus (3 PP)'
        },
        slot4Accessory: {
          bestInSlot: 'Sapphire Pendant',
          optimalAlternatives: ['Lapis Pendant', 'Onyx Pendant', 'First Aid Kit'],
          slotType: 'Accessory',
          notes: 'PP +2 ensuring total PP >= 4'
        },
        statPriorities: ['PP (+4 Required)', 'Initiative (B)', 'Healing (A)'],
        growthTypes: ['Guardian', 'Speedster']
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Royal Saber', 'Meteorite Sword', 'Hallowed Blade'],
          slotType: 'Weapon',
          notes: 'Phys Atk +25, Initiative +5'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Royal Scarf',
          optimalAlternatives: ['Crown Shield', 'Silver Shield', 'Leather Hood'],
          slotType: 'Helm',
          notes: 'Initiative +5, Evasion +10'
        },
        slot3Accessory: {
          bestInSlot: 'Angel Plume',
          optimalAlternatives: ['Raven Plume', 'Dove Plume', 'Wingline Standard'],
          slotType: 'Accessory',
          notes: 'Tailwind Array: Start of Battle +20 Squad Initiative'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Carnelian Pendant', 'Commander\'s Crest', 'Sapphire Pendant'],
          slotType: 'Accessory',
          notes: 'PP +1 for Rapid Order & Offensive Order'
        },
        statPriorities: ['Initiative (S+)', 'Phys Def (B)', 'PP +2'],
        growthTypes: ['Speedster', 'Guardian']
      }
    ],
    tacticsSequence: [
      { step: 1, unit: 'Gilbert', skill: 'Rapid Order', condition1: '[Start of Battle]', condition2: '[Full Squad]', notes: '+15 Squad Initiative buff' },
      { step: 2, unit: 'Gilbert', skill: 'Offensive Order', condition1: '[Start of Battle]', condition2: '[Full Squad]', notes: '+20% Phys/Mag Attack buff' },
      { step: 3, unit: 'Hilda', skill: 'Dragoon Dive', condition1: '[Target: All Enemies]', condition2: '[Self AP >= 4]', notes: 'Aerial 4 AP charge bomb' },
      { step: 4, unit: 'Primm', skill: 'Quick Impetus', condition1: '[Ally Using Charge Skill]', condition2: '[Target: Hilda]', notes: 'White Cat-Ear instant dive' },
      { step: 5, unit: 'Hilda', skill: 'Eagle Eye', condition1: '[Before Dragoon Dive Hits]', condition2: '[Self PP >= 1]', notes: '100% Critical True Strike wipe' },
      { step: 6, unit: 'Fran', skill: 'High Gale', condition1: '[Back Row / Cavalry]', condition2: '[Self AP >= 2]', notes: 'Cleans up survivors' }
    ],
    substitutes: { earlyGame: ['Celeste Gryphon', 'Sharon Cleric'], endgameAlternatives: ['Celeste replacing Fran'] }
  },
  {
    ...
    keyItems: ['Carnelian Greataxe', 'Poisoner\'s Dagger', 'Executioner\'s Eye', 'Phantom Ring'],
    ...
    counters: ['Affliction Immunity Rings (Ring of the Unicorn/Maiden)'],
    strategyGuide: {
    ...
    unitGearConfigs: [
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Kingsaxe Drakenash', 'Boreas\'s Axe', 'Meteorite Axe'],
          slotType: 'Weapon',
          notes: 'Phys Atk +25, AP +1'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Nightmare Shield',
          optimalAlternatives: ['Azure Crest Shield', 'Rose Shield', 'Silver Shield'],
          slotType: 'Shield',
          notes: 'Phys Def +14, Affliction Potency +20%'
        },
        slot3Accessory: {
          bestInSlot: 'Executioner\'s Eye',
          optimalAlternatives: ['Earrings of Pursuit', 'Critical Ring', 'Warrior\'s Medallion'],
          slotType: 'Accessory',
        ...
        statPriorities: ['Phys Atk (S+)', 'Initiative (S)', 'Phys Def (A)'],
        growthTypes: ['Offensive', 'Keen']
      },
      {
        unitId: 'travis-rogue',
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Shadow Dagger', 'Thief\'s Dagger', 'Notos\'s Sword'],
          slotType: 'Weapon',
          notes: 'Phys Atk +18, Poison Affliction on hit'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Thief\'s Mantle',
          optimalAlternatives: ['Shadow Hood', 'Silk Hood', 'Leather Hood'],
          slotType: 'Helm',
          notes: 'Evasion +20, Evade PP +1'
        },
        slot3Accessory: {
          bestInSlot: 'Phantom Ring',
          optimalAlternatives: ['Lucky Coin', 'Thief\'s Bell', 'Skillful Amulet'],
          slotType: 'Accessory',
          notes: 'Shadowbite: Row Blindness affliction'
        },
        slot4Accessory: {
          bestInSlot: 'Raven Plume',
          optimalAlternatives: ['Dove Plume', 'Lapis Pendant', 'Carnelian Pendant'],
          slotType: 'Accessory',
          notes: 'Initiative +15 for Turn-1 Shadowbite'
        },
        statPriorities: ['Initiative (S+)', 'Evasion (S+)', 'PP +2'],
        growthTypes: ['Speedster', 'Speedster']
      },
      {
        unitId: 'nina-breaker',
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Meteorite Axe', 'Giant\'s Greataxe', 'Carnelian Axe'],
          slotType: 'Weapon',
          notes: 'Phys Atk +26, Stun Multiplier'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Gauntlets of Power',
          optimalAlternatives: ['Armored Gauntlets', 'Heavy Gauntlets', 'Power Belt'],
          slotType: 'Helm',
          notes: 'Phys Atk +5, Guard Pierce +10%'
        },
        slot3Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Warrior\'s Medallion', 'Power Belt'],
          slotType: 'Accessory',
          notes: 'PP +1 for Heavy Impact'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Power Belt', 'Critical Ring'],
          slotType: 'Accessory',
          notes: 'AP +1 for Assault Blow executions'
        },
        statPriorities: ['Phys Atk (S+)', 'Crit Rate (B)', 'AP +1'],
        growthTypes: ['Offensive', 'Offensive']
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Apeliotes\'s Bow', 'Carnelian Bow', 'Meteorite Bow'],
          slotType: 'Weapon',
          notes: 'Phys Atk +24, Anti-Flying 200%'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Greatshield of Fortitude',
          optimalAlternatives: ['Deflect Shield', 'Silver Shield', 'Heavy Guard Shield'],
          slotType: 'Shield',
          notes: 'Phys Def +18, Guard Rate +45%'
        },
        slot3Accessory: {
          bestInSlot: 'First Aid Kit',
          optimalAlternatives: ['Large Aid Kit', 'Medical Kit', 'Self-Aid Kit'],
          slotType: 'Accessory',
          notes: 'End of battle emergency healing'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Carnelian Pendant', 'Dove Plume', 'Vitality Talisman'],
          slotType: 'Accessory',
          notes: 'PP +1 for Medical Shot & Greatshield Cover'
        },
        statPriorities: ['Phys Def (A)', 'Healing (A)', 'Phys Atk (B)'],
        growthTypes: ['Guardian', 'Defender']
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Meteorite Axe', 'Carnelian Axe', 'Giant\'s Greataxe'],
          slotType: 'Weapon',
          notes: 'Phys Atk +22, PP +1'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Power Belt',
          optimalAlternatives: ['Riot Belt', 'Counter Belt', 'Armored Gauntlets'],
          slotType: 'Helm',
        ...
        slot4Accessory: {
          ...
          optimalAlternatives: ['Lifeblood Talisman', 'Lapis Pendant', 'Lionheart'],
          slotType: 'Accessory',
          notes: 'Max HP +25, synergy with Bulk Up'
        },
        statPriorities: ['Max HP (S+)', 'Phys Atk (S)', 'Sustain (A)'],
        growthTypes: ['Offensive', 'Guardian']
      }
    ],
    tacticsSequence: [
      { step: 1, unit: 'Berengaria', skill: 'Eye of the Crimson Bear', condition1: '[Start of Battle]', condition2: '[All Enemies]', notes: '-20% Atk/Def & -10 Init debuff' },
      { step: 2, unit: 'Travis', skill: 'Shadowbite', condition1: '[Front Row Enemies]', condition2: '[Self AP >= 2]', notes: 'Inflicts Row Blindness & Affliction' },
      { step: 3, unit: 'Berengaria', skill: 'Sanguine Pursuit', condition1: '[Target Afflicted]', condition2: '[Self PP >= 1]', notes: 'Recovers AP/PP upon hit' },
      { step: 4, unit: 'Nina', skill: 'Enraged Strike', condition1: '[Armored Target]', condition2: '[Self AP >= 1]', notes: '100% Physical Defense bypass' },
      { step: 5, unit: 'Bruno', skill: 'Wide Smash', condition1: '[Enemy Row >= 2]', condition2: '[Self AP >= 2]', notes: 'Cleaves entire enemy row' }
    ],
    substitutes: { earlyGame: ['Travis Thief', 'Nina Warrior', 'Bruno Gladiator'], endgameAlternatives: ['Morax replacing Bruno'] }
  },
  {
    ...
    keyItems: ['Maiden\'s Sword', 'Rose Shield', 'Counter Belt', 'Apeliotes\'s Bow'],
    frontRow: ['virginia-valkyria', 'colm-vanguard'],
    backRow: ['leah-swordmaster', 'kitra-breaker', 'rolf-sniper'],
    pros: [
    ...
    counters: ['Heavy Row Magic Nukes (Trinity Rain)'],
    strategyGuide: {
    ...
    unitGearConfigs: [
      {
        ...
        slot2ShieldOrOffhand: {
          ...
          optimalAlternatives: ['Greatshield of the Maiden', 'Azure Crest Shield', 'Silver Shield'],
          slotType: 'Shield',
          notes: 'Phys Def +15, Guard Rate +35%, Retaliation Counter, PP +1'
        },
        slot3Accessory: {
          bestInSlot: 'Counter Belt',
          optimalAlternatives: ['Retaliation Earrings', 'Rose Broach', 'Lionheart'],
          slotType: 'Accessory',
        ...
        statPriorities: ['Phys Def (S+)', 'Guard Rate (100%)', 'Phys Atk (A)'],
        growthTypes: ['Offensive', 'Guardian']
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Hallowed Blade', 'Iron Sword', 'Bronze Sword'],
          slotType: 'Weapon',
          notes: 'Phys Atk +24, Max HP +20, Guard +10%'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Deflect Shield',
          optimalAlternatives: ['Silver Shield', 'Knight Shield', 'Azure Crest Shield'],
          slotType: 'Shield',
          notes: 'Arrow Deflect: Negates 100% arrow damage'
        },
        slot3Accessory: {
          bestInSlot: 'Heavy Guard Ring',
          optimalAlternatives: ['Defender\'s Ring', 'Guardian Gloves', 'Defensive Ring'],
          slotType: 'Accessory',
          notes: 'Guard Rate +15%'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Carnelian Pendant', 'Vitality Talisman', 'Dove Plume'],
          slotType: 'Accessory',
          notes: 'PP +1 for Arrow Cover activations'
        },
        statPriorities: ['Phys Def (S)', 'Guard Rate (A)', 'HP (A)'],
        growthTypes: ['Guardian', 'Defender']
      },
      {
        ...
        slot1Weapon: {
          bestInSlot: 'Notos\'s Sword',
          optimalAlternatives: ['Meteorite Sword', 'Keen Broadsword', 'Kingsblade Cornix'],
          slotType: 'Weapon',
          notes: 'Phys Atk +25, Initiative +5'
        },
        slot2ShieldOrOffhand: {
        ...
        slot3Accessory: {
          bestInSlot: 'Parrying Amulet',
          optimalAlternatives: ['Lucky Coin', 'Critical Ring', 'Skillful Amulet'],
          slotType: 'Accessory',
          notes: 'Parrying Slash retaliation on melee strike'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Warrior\'s Medallion', 'Critical Ring'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Juggernaut', 'Giant\'s Greataxe', 'Carnat Axe'],
          slotType: 'Weapon',
          notes: 'Phys Atk +24, Max HP +20'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Armored Gauntlets',
          optimalAlternatives: ['Heavy Gauntlets', 'Power Belt', 'Gauntlets of Power'],
          slotType: 'Helm',
        ...
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Power Belt', 'Critical Ring'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Meteorite Bow', 'Eagle Eye Bow', 'Carnelian Bow'],
          slotType: 'Weapon',
          notes: 'Phys Atk +25, Initiative +5, True Strike'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Sniper Hood',
          optimalAlternatives: ['Silk Hood', 'Elite Beret', 'Leather Hood'],
          slotType: 'Helm',
          notes: 'Crit Rate +10%, Acc +15'
        },
        slot3Accessory: {
          bestInSlot: 'Sniper\'s Lens',
          optimalAlternatives: ['Sniper\'s Amber Lens', 'Skillful Amulet', 'Archer\'s Eyepatch'],
          slotType: 'Accessory',
          notes: 'Hawkeye: 100% True Strike'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Carnelian Pendant', 'Dove Plume', 'Warrior\'s Medallion'],
          slotType: 'Accessory',
          notes: 'PP +1 for Eagle Eye triggers'
        },
        statPriorities: ['Phys Atk (S)', 'Accuracy (S+)', 'Crit Rate (A)'],
        growthTypes: ['Offensive', 'Keen']
      }
    ],
    tacticsSequence: [
      { step: 1, unit: 'Virginia', skill: 'Iron Veil', condition1: '[Start of Battle]', condition2: '[Full Squad]', notes: '+30% Phys Def & Guard Rate' },
      { step: 2, unit: 'Virginia', skill: 'Maiden\'s Hammer', condition1: '[Enemy Guarding]', condition2: '[Self AP >= 2]', notes: 'Breaks enemy guard for 200% damage' },
      { step: 3, unit: 'Leah', skill: 'Parrying Slash', condition1: '[Attacked by Melee]', condition2: '[Self PP >= 1]', notes: 'Negates 100% damage & strikes back' },
      { step: 4, unit: 'Kitra', skill: 'Enraged Strike', condition1: '[Armored Enemy]', condition2: '[Self AP >= 1]', notes: '100% Physical Defense bypass' },
      { step: 5, unit: 'Rolf', skill: 'Aerial Snipe', condition1: '[Flying Enemy]', condition2: '[Self AP >= 1]', notes: '200% flying multiplier True Strike' }
    ],
    substitutes: { earlyGame: ['Lex Fighter', 'Rolf Hunter'], endgameAlternatives: ['Miriam Sainted Knight replacing Colm'] }
  },
  {
    ...
    keyItems: ['Icefall Bow (Glacial Bow)', 'Ice Crystal Ring', 'Owl Pin', 'Pure Light Amulet'],
    ...
    counters: ['Freeze Immunity Amulets', 'Start-of-Battle Stun'],
    strategyGuide: {
    ...
    unitGearConfigs: [
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Kingsbow Bastorik', 'Meteorite Bow', 'Apeliotes\'s Bow'],
          slotType: 'Weapon',
          notes: 'Glacial Rain 4 AP, Freeze, Phys Atk +22'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Snow Wolf Hood',
          optimalAlternatives: ['Elite Beret', 'Leather Hood', 'Silk Hood'],
          slotType: 'Helm',
          notes: 'Phys Atk +5, Freeze Potency +20%'
        },
        slot3Accessory: {
          bestInSlot: 'Sniper\'s Amber Lens',
          optimalAlternatives: ['Ice Crystal Ring', 'Sniper\'s Lens', 'Skillful Amulet'],
          slotType: 'Accessory',
          notes: 'Eagle Eye: Guaranteed 100% Crit + True Strike'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Lucky Coin', 'Warrior\'s Medallion'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Sacral Rod', 'Kingstaff Albiore', 'Euros\'s Staff'],
          slotType: 'Weapon',
          notes: 'Mag Atk +24, Max HP +20'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Sage\'s Owl Shawl',
          optimalAlternatives: ['Silk Hood', 'Druid\'s Robes', 'Dusk Robes'],
          slotType: 'Helm',
          notes: 'Mag Def +8, Initiative +6'
        },
        slot3Accessory: {
          bestInSlot: 'Owl Pin (Owl Eyes PP restoration)',
          optimalAlternatives: ['Lapis Pendant', 'Sapphire Pendant', 'Dove Plume'],
          slotType: 'Accessory',
          notes: 'Owl Eyes: Restores 1 PP to ally using active skill'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Dove Plume', 'Amethyst Pendant'],
          slotType: 'Accessory',
          notes: 'PP +1 for continuous Restore casting'
        },
        statPriorities: ['Initiative (S)', 'PP (S+)', 'Mag Atk (B)'],
        growthTypes: ['Speedster', 'Guardian']
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Meteorite Bow', 'Sacral Bow', 'Apeliotes\'s Bow'],
          slotType: 'Weapon',
          notes: 'Phys Atk +18, Mag Atk +24'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Elven Tiara',
          optimalAlternatives: ['Silk Hood', 'Sage\'s Hood', 'Elite Beret'],
          slotType: 'Helm',
          notes: 'Mag Atk +5, Mag Def +5'
        },
        slot3Accessory: {
          bestInSlot: 'Pure Light Amulet',
          optimalAlternatives: ['Clearsight Amulet', 'Detoxifying Amulet', 'Lapis Pendant'],
          slotType: 'Accessory',
          notes: 'Pure Light: Row-wide cleanse on affliction'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Carnelian Pendant', 'Dove Plume', 'Skillful Amulet'],
          slotType: 'Accessory',
          notes: 'PP +1 for Mystic Conferral'
        },
        statPriorities: ['Mag Atk (A)', 'Initiative (A)', 'Phys Atk (B)'],
      ...
      },
      {
        ...
        slot3Accessory: {
          ...
          optimalAlternatives: ['Defender\'s Ring', 'Defensive Ring', 'Heavy Guard Ring'],
          slotType: 'Accessory',
          notes: 'Guard Rate +15%'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Vitality Talisman', 'Lifeblood Talisman'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        statPriorities: ['Phys Def (A)', 'Guard Rate (A)', 'HP (B)'],
        growthTypes: ['Guardian', 'Defender']
      }
    ],
    tacticsSequence: [
      { step: 1, unit: 'Yunifi', skill: 'Glacial Rain', condition1: '[Target: All Enemies]', condition2: '[Self AP >= 4]', notes: 'Battlefield Freeze Arrow Volley' },
      { step: 2, unit: 'Ramona', skill: 'Owl Eyes', condition1: '[Ally Used Active Skill]', condition2: '[Target: Yunifi]', notes: 'Restores 1 PP to Yunifi' },
      { step: 3, unit: 'Ridiel', skill: 'Pure Light', condition1: '[Ally Afflicted]', condition2: '[Self PP >= 1]', notes: 'Cleanses debuffs row-wide' },
      { step: 4, unit: 'Yunifi', skill: 'Triple Counter', condition1: '[Attacked by Enemy]', condition2: '[Self PP >= 1]', notes: '3-hit counter attack with 100% Crit' }
    ],
    substitutes: { earlyGame: ['Rolf Hunter', 'Chloe Soldier'], endgameAlternatives: ['Morax replacing Lex'] }
  },
  {
    ...
    keyItems: ['Kingslance Elhal', 'Sylphid Spear', 'Elven Crown', 'Familiar\'s Choker'],
    ...
    counters: ['Featherstaff Magic Reflection'],
    strategyGuide: {
    ...
    unitGearConfigs: [
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Kingslance Elhal', 'Runic Spear', 'Meteorite Lance'],
          slotType: 'Weapon',
          notes: 'Phys Atk +22, Mag Atk +20, Initiative +8'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Elven Crown',
          optimalAlternatives: ['Ancient Crown', 'Sage\'s Hood', 'Silk Hood'],
          slotType: 'Helm',
        ...
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Raven Plume', 'Amethyst Pendant'],
          slotType: 'Accessory',
          notes: 'AP +1 for Elemental Roar (3 AP)'
        },
        statPriorities: ['Mag Atk (S+)', 'Initiative (S)', 'Phys Atk (A)'],
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Sylphid Spear', 'Runic Spear', 'Meteorite Lance'],
          slotType: 'Weapon',
          notes: 'Phys Atk +28, All Stats +5'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Elven Tiara',
          optimalAlternatives: ['Archbishop\'s Mitre', 'Silk Hood', 'Sage\'s Hood'],
          slotType: 'Helm',
          notes: 'Mag Atk +6, Mag Def +6, PP +1'
        },
        slot3Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Amethyst Pendant', 'Celestial Talisman'],
          slotType: 'Accessory',
          notes: 'PP +1 for Boon of the Faeries barrier'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Dove Plume', 'Warrior\'s Medallion'],
          slotType: 'Accessory',
          notes: 'AP +1 for second Elemental Roar'
        },
        statPriorities: ['Mag Atk (S)', 'Initiative (A)', 'Healing (S)'],
        growthTypes: ['Guardian', 'Speedster']
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Runic Sword', 'Notos\'s Sword', 'Meteorite Sword'],
          slotType: 'Weapon',
          notes: 'Mag Atk +22, Mag Def +5, Initiative +3'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Mirage Cloak',
          optimalAlternatives: ['Thief\'s Mantle', 'Silk Hood', 'Leather Hood'],
          slotType: 'Helm',
          notes: 'Evasion +20, Mirage Step'
        },
        slot3Accessory: {
          bestInSlot: 'Raven Plume',
          optimalAlternatives: ['Dove Plume', 'Lucky Coin', 'Thief\'s Bell'],
          slotType: 'Accessory',
          notes: 'Initiative +15 for Turn-1 frontline stun'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Lapis Pendant', 'Skillful Amulet', 'Ruby Pendant'],
          slotType: 'Accessory',
          notes: 'AP +1 for Lightning Sword'
        },
        statPriorities: ['Initiative (S+)', 'Evasion (S)', 'Mag Atk (A)'],
        growthTypes: ['Speedster', 'Keen']
      },
      {
        ...
        slot1Weapon: {
          bestInSlot: 'Runic Sword',
          optimalAlternatives: ['Phantom Knight\'s Sword', 'Meteorite Sword', 'Hallowed Blade'],
          slotType: 'Weapon',
          notes: 'Phys Atk +18, Mag Atk +24'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Dusk Robes',
          optimalAlternatives: ['Dawn Robes', 'Silk Hood', 'Druid\'s Robes'],
          slotType: 'Helm',
          notes: 'Mag Def +12, Evasion +10'
        },
        slot3Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Raven Plume', 'Dove Plume'],
          slotType: 'Accessory',
          notes: 'PP +1 for Mirage Step dodges'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Lucky Coin', 'Critical Ring'],
          slotType: 'Accessory',
          notes: 'AP +1 for Windstorm Blade'
        },
        statPriorities: ['Evasion (S)', 'Mag Atk (A)', 'Initiative (A)'],
        growthTypes: ['Speedster', 'Speedster']
      },
      {
        ...
        slot1Weapon: {
          bestInSlot: 'Runic Bow',
          optimalAlternatives: ['Meteorite Bow', 'Apeliotes\'s Bow', 'Sacral Bow'],
          slotType: 'Weapon',
          notes: 'Phys Atk +18, Mag Atk +24'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Silk Hood',
          optimalAlternatives: ['Sage\'s Hood', 'Elite Beret', 'Leather Hood'],
          slotType: 'Helm',
          notes: 'Mag Def +4, Initiative +3'
        },
        slot3Accessory: {
        ...
        statPriorities: ['Mag Atk (A)', 'Initiative (A)', 'Healing (B)'],
        growthTypes: ['All-Rounder', 'Speedster']
      }
    ],
    tacticsSequence: [
      ...
      { step: 2, unit: 'Eltolinde', skill: 'Boon of the Faeries', condition1: '[Start of Battle]', condition2: '[Full Squad]', notes: 'Magic barrier immunity' },
      { step: 3, unit: 'Rosalinde', skill: 'Elemental Roar', condition1: '[Target: All Enemies]', condition2: '[Self AP >= 3]', notes: 'First 210 potency hybrid nuke' },
      { step: 4, unit: 'Eltolinde', skill: 'Elemental Roar', condition1: '[Target: All Enemies]', condition2: '[Self AP >= 3]', notes: 'Second consecutive hybrid nuke' },
      { step: 5, unit: 'Ithilion', skill: 'Lightning Sword', condition1: '[Enemy Not Stunned]', condition2: '[Self AP >= 1]', notes: 'Stuns any survivors' }
    ],
    substitutes: { earlyGame: ['Ridiel Elven Archer', 'Lhinalo Elven Archer'], endgameAlternatives: ['Yahna replacing Galadmir'] }
  },
  {
    ...
    keyItems: ['Grand Crusher Greatsword', 'Berserker Band', 'Heavy Guard Shield', 'Radiant Shield'],
    ...
    counters: ['Heavy Ranged Flying Squads (neutralized by Mandrin)'],
    strategyGuide: {
    ...
    unitGearConfigs: [
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Kingsblade Cornix', 'Meteorite Sword', 'Juggernaut'],
          slotType: 'Weapon',
          notes: 'Phys Atk +28, Guard Piercing +50%'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Heavy Guard Shield',
          optimalAlternatives: ['Greatshield of Fortitude', 'Silver Shield', 'Azure Crest Shield'],
          slotType: 'Shield',
          notes: 'Phys Def +14, Guard Rate +30%'
        },
        slot3Accessory: {
          bestInSlot: 'Berserker Band',
          optimalAlternatives: ['Warrior\'s Medallion', 'Power Belt', 'Lionheart'],
          slotType: 'Accessory',
          notes: 'Phys Atk +20%'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Sniper\'s Amber Lens', 'Critical Ring'],
          slotType: 'Accessory',
          notes: 'AP +1 for Penetrate column strikes'
        },
        statPriorities: ['Phys Atk (S+)', 'Crit Rate (A)', 'AP +1'],
        growthTypes: ['Offensive', 'Offensive']
      },
      {
        ...
        slot3Accessory: {
          bestInSlot: 'Vitality Talisman',
          optimalAlternatives: ['Lifeblood Talisman', 'Guardian Gloves', 'Defender\'s Ring'],
          slotType: 'Accessory',
          notes: 'Max HP +25, Indomitable Guard synergy'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Heavy Guard Ring', 'Defender\'s Ring'],
          slotType: 'Accessory',
          notes: 'PP +1 for Ground Slam taunt'
        },
        statPriorities: ['Max HP (S+)', 'Phys Def (S)', 'Guard Rate (A)'],
        growthTypes: ['Guardian', 'Defender']
      },
      {
        ...
        slot1Weapon: {
          bestInSlot: 'Runic Sword',
          optimalAlternatives: ['Hallowed Blade', 'Notos\'s Sword', 'Phantom Knight\'s Sword'],
          slotType: 'Weapon',
          notes: 'Phys Atk +18, Mag Atk +24'
        },
        slot2ShieldOrOffhand: {
        ...
        statPriorities: ['Mag Def (S)', 'Healing (S)', 'Initiative (A)'],
      ...
      },
      {
        ...
        statPriorities: ['Crit Rate (S+)', 'Initiative (A)', 'Phys Atk (A)'],
        growthTypes: ['Keen', 'Keen']
      },
      {
        ...
        statPriorities: ['Phys Atk (A)', 'Accuracy (S+)', 'Crit Rate (A)'],
        growthTypes: ['Offensive', 'Keen']
      }
    ],
    tacticsSequence: [
      ...
      { step: 2, unit: 'Amalia', skill: 'Penetrate', condition1: '[Target Column]', condition2: '[Self AP >= 2]', notes: 'Ignores 50% defense & breaks guard' },
      { step: 3, unit: 'Mandrin', skill: 'Aerial Snipe', condition1: '[Flying Enemy]', condition2: '[Self AP >= 1]', notes: '200% anti-flying damage' },
      { step: 4, unit: 'Monica', skill: 'Row Heal', condition1: '[Ally HP <= 50%]', condition2: '[Self PP >= 1]', notes: 'Sustains frontline' },
      { step: 5, unit: 'Aramis', skill: 'Meteor Slash', condition1: '[Low HP Enemy]', condition2: '[Self AP >= 2]', notes: 'Executes targets' }
    ],
    substitutes: { earlyGame: ['Mordon Warrior', 'Josef Paladin'], endgameAlternatives: ['Morax replacing Bertrand'] }
  },
  {
    ...
    keyItems: ['Wolfpack Gauntlets', 'Wolf-Fang Bracelet', 'Shadow Dagger', 'Divine Bow'],
    ...
    unitGearConfigs: [
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Carnelian Blade', 'Notos\'s Sword', 'Meteorite Sword'],
          slotType: 'Weapon',
          notes: 'Wolfpack Strike: +20% Bestral Atk, Phys Atk +5, Crit +10%'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Wolf Cap',
          optimalAlternatives: ['Leather Hood', 'Elite Beret', 'Silk Hood'],
          slotType: 'Helm',
          notes: 'Initiative +5, Crit Rate +10%'
        },
        slot3Accessory: {
          bestInSlot: 'Wolf-Fang Bracelet',
          optimalAlternatives: ['Beast Ring', 'Lucky Coin', 'Warrior\'s Medallion'],
          slotType: 'Accessory',
          notes: 'Phys Atk +5, Bestral Boost'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Raven Plume', 'Power Belt'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Meteorite Sword', 'Shadow Dagger', 'Iron Sword'],
          slotType: 'Weapon',
          notes: 'Phys Atk +25, AP +1'
        },
        slot2ShieldOrOffhand: {
        ...
        slot3Accessory: {
          bestInSlot: 'Raven Plume',
          optimalAlternatives: ['Dove Plume', 'Wolf-Fang Bracelet', 'Lucky Coin'],
          slotType: 'Accessory',
          notes: 'Initiative +15 for early turn order'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Skillful Amulet', 'Earrings of Pursuit'],
          slotType: 'Accessory',
          notes: 'PP +1 for Chasing Slash follow-ups'
        },
        statPriorities: ['Initiative (S+)', 'Evasion (S)', 'Phys Atk (A)'],
        growthTypes: ['Offensive', 'Keen']
      },
      {
        ...
        slot1Weapon: {
          bestInSlot: 'Meteorite Axe',
          optimalAlternatives: ['Giant\'s Greataxe', 'Juggernaut', 'Carnat Axe'],
          slotType: 'Weapon',
          notes: 'Phys Atk +24, Max HP +20'
        },
        slot2ShieldOrOffhand: {
      ...
      },
      {
        ...
        slot1Weapon: {
          bestInSlot: 'Apeliotes\'s Bow',
          optimalAlternatives: ['Meteorite Bow', 'Divine Bow', 'Carnelian Bow'],
          slotType: 'Weapon',
          notes: 'Phys Atk +25, Initiative +5, True Strike'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Angel Plume',
          optimalAlternatives: ['Wingline Standard', 'Silk Hood', 'Sage\'s Hood'],
          slotType: 'Helm',
          notes: 'Tailwind Array: Start of Battle +20 Squad Initiative'
        },
        slot3Accessory: {
          bestInSlot: 'Raven Plume',
          optimalAlternatives: ['Dove Plume', 'Sniper\'s Lens', 'Skillful Amulet'],
          slotType: 'Accessory',
        ...
        statPriorities: ['Initiative (S+ #1 in Game)', 'Evasion (S+)', 'Accuracy (S)'],
        growthTypes: ['Speedster', 'Speedster']
      },
      {
        ...
        slot1Weapon: {
          bestInSlot: 'Kingsblade Cornix',
          optimalAlternatives: ['Meteorite Sword', 'Hallowed Blade', 'Iron Broadsword'],
          slotType: 'Weapon',
          notes: 'Phys Atk +28, All Stats +5'
        },
        slot2ShieldOrOffhand: {
        ...
        slot4Accessory: {
          bestInSlot: 'Power Belt',
          optimalAlternatives: ['Lapis Pendant', 'Earrings of Pursuit', 'Gauntlets of Power'],
          slotType: 'Accessory',
    ...
    tacticsSequence: [
      { step: 1, unit: 'Raenys', skill: 'Shining Arrow', condition1: '[Start of Battle]', condition2: '[Front Row Enemies]', notes: 'Inflicts Blindness on front row' },
      { step: 2, unit: 'Dinah', skill: 'Wolfpack Roar', condition1: '[Start of Battle]', condition2: '[Full Squad]', notes: '+20% Bestral Atk & Initiative' },
      { step: 3, unit: 'Govil', skill: 'Shadow Slash', condition1: '[Front Row Target]', condition2: '[Self AP >= 1]', notes: 'Shreds armor & triggers pursuit' },
      { step: 4, unit: 'Dinah', skill: 'Chasing Slash', condition1: '[Enemy Damaged]', condition2: '[Self PP >= 1]', notes: 'Immediate execution pursuit' },
      { step: 5, unit: 'Jeremy', skill: 'Following Slash', condition1: '[Ally Hit Target]', condition2: '[Self PP >= 1]', notes: 'Follow-up fatal strike' }
    ],
    substitutes: { earlyGame: ['Travis Thief', 'Berenice Landsknecht'], endgameAlternatives: ['Bertrand Werebear replacing Morpan'] }
  },
  {
    ...
    keyItems: ['Sacred Feather Rod', 'Angel\'s Reflection Shield', 'Ring of the Maiden', 'Dark Knight Cleaver'],
    ...
    counters: ['Continuous Multi-Hit True-Strike Attacks'],
    strategyGuide: {
    ...
    unitGearConfigs: [
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Kingstaff Albiore', 'Euros\'s Staff', 'Sacral Rod'],
          slotType: 'Weapon',
          notes: 'Sacred Barrier: Start of Battle 2-Hit Squad Nullification'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Archbishop\'s Mitre',
          optimalAlternatives: ['Monk\'s Mitre', 'Angel Cap', 'Silk Hood'],
          slotType: 'Helm',
          notes: 'Row Refresh, Mag Def +10, Healing +20'
        },
        slot3Accessory: {
          bestInSlot: 'Ring of the Maiden',
          optimalAlternatives: ['Holy Maiden Ring', 'Holy Broach', 'Celestial Talisman'],
          slotType: 'Accessory',
          notes: 'Mag Def +10, AP +1, PP +1, Maiden\'s Protection'
        },
        slot4Accessory: {
        ...
        statPriorities: ['Mag Def (S+)', 'Initiative (S)', 'Healing (S)'],
        growthTypes: ['Guardian', 'Speedster']
      },
      {
        ...
        slot1Weapon: {
          bestInSlot: 'Notos\'s Sword',
          optimalAlternatives: ['Hallowed Blade', 'Meteorite Sword', 'Divine Sword'],
          slotType: 'Weapon',
        ...
        slot3Accessory: {
          ...
          optimalAlternatives: ['Thief\'s Mantle', 'Lucky Coin', 'Silverscale Shield'],
          slotType: 'Accessory',
          notes: 'Evasion +15, Initiative +5'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Lapis Pendant', 'Warrior\'s Medallion'],
          slotType: 'Accessory',
          notes: 'AP +1 for Spiral Sword slashes'
        },
        statPriorities: ['Evasion (S+)', 'Initiative (S)', 'Phys Atk (A)'],
        growthTypes: ['Speedster', 'Keen']
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Notos\'s Sword', 'Meteorite Sword', 'Divine Sword'],
          slotType: 'Weapon',
          notes: 'Phys Atk +24, HP Regen +10%'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Silver Shield',
          optimalAlternatives: ['Azure Crest Shield', 'Angel Shield', 'Knight Shield'],
          slotType: 'Shield',
          notes: 'Phys Def +11, Guard Rate +25%'
        },
        slot3Accessory: {
          bestInSlot: 'Wingline Standard',
          optimalAlternatives: ['Feather Amulet', 'Skillful Amulet', 'Lucky Coin'],
          slotType: 'Accessory',
          notes: 'Squad Flying Atk +15%, Initiative +5'
        },
        slot4Accessory: {
        ...
        statPriorities: ['Evasion (S+)', 'Phys Atk (A)', 'Initiative (A)'],
        growthTypes: ['Speedster', 'Offensive']
      },
      {
        ...
        slot2ShieldOrOffhand: {
          bestInSlot: 'Silk Hood',
          optimalAlternatives: ['Archbishop\'s Mitre', 'Monk\'s Mitre', 'Cleric Hat'],
          slotType: 'Helm',
          notes: 'Mag Def +4, Initiative +3'
        },
        slot3Accessory: {
        ...
        statPriorities: ['Healing (S+)', 'Mag Def (S)', 'PP (+4 Required)'],
        growthTypes: ['Guardian', 'Defender']
      },
      {
        ...
        slot4Accessory: {
          ...
          optimalAlternatives: ['Lapis Pendant', 'Retaliation Earrings', 'Power Belt'],
          slotType: 'Accessory',
          notes: 'Phys Atk +5, Mag Atk +5'
        },
        statPriorities: ['Phys Atk (S)', 'Mag Atk (B)', 'AP +1'],
        growthTypes: ['Offensive', 'Offensive']
      }
    ],
    tacticsSequence: [
      { step: 1, unit: 'Sanatio', skill: 'Sacred Barrier', condition1: '[Start of Battle]', condition2: '[Full Squad]', notes: '2 hits nullification barrier to squad' },
      { step: 2, unit: 'Ochlys', skill: 'Spiral Sword', condition1: '[Front Row Enemies]', condition2: '[Self AP >= 1]', notes: 'Evasive aerial row slice' },
      { step: 3, unit: 'Umerus', skill: 'Spiral Sword', condition1: '[Low HP Enemy]', condition2: '[Self AP >= 1]', notes: 'Guard-bypassing thrust' },
      { step: 4, unit: 'Gloucester', skill: 'Dark Flame', condition1: '[Enemy Row >= 2]', condition2: '[Self AP >= 2]', notes: 'Row magic flame hit scaling with vengeance' },
      { step: 5, unit: 'Tatiana', skill: 'Row Heal', condition1: '[Ally HP <= 75%]', condition2: '[Self PP >= 1]', notes: 'Maintains 100% squad health' }
    ],
    substitutes: { earlyGame: ['Sharon Cleric', 'Ochlys Feathersword'], endgameAlternatives: ['Renault Great Knight replacing Doom Knight'] }
  }
];
...
fs.writeFileSync('src/data/zeroOverlapSquads.ts', fileContent, 'utf8');
console.log('Successfully wrote src/data/zeroOverlapSquads.ts with 10 zero-overlap meta squads!');
