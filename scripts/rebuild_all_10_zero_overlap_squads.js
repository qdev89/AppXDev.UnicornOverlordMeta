...
const ZERO_OVERLAP_SQUADS = [
  ...
  // ============================================================================
  {
    ...
    frontRow: ['alain-high-lord', 'melisandre-swordmaster'],
    backRow: ['scarlett-high-priestess', 'clive-great-knight', 'chloe-sergeant'],
    keyItems: ['Holy Unicorn Blade', 'Holy Unicorn Shield', 'Ring of the Unicorn', 'Chloe\'s Charm'],
    counters: ['Infantry heavy formations', 'Magic glass cannons'],
    strategyGuide: {
    ...
    unitGearConfigs: [
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Notos\'s Sword', 'Meteorite Sword', 'General\'s Saber'],
          slotType: 'Weapon',
          notes: 'Main-Hand Slot: Phys Atk +28, All Stats +5.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Black-Iron Sword',
          optimalAlternatives: ['Flamberge', 'Notos\'s Sword', 'Meteorite Sword'],
          slotType: 'Weapon',
          notes: 'Dual-Wield Off-Hand Slot: Phys Atk +17, Crit Rate +5%. House Meillet relic.'
        },
        slot3Accessory: {
          bestInSlot: 'Parrying Amulet',
          optimalAlternatives: ['Retaliation Earrings', 'Warrior\'s Medallion', 'Lucky Coin'],
          slotType: 'Accessory',
          notes: 'Guard Cure, Negates physical melee and counters.'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Sniper\'s Lens', 'Critical Talisman'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        growthTypes: ['Go-Getter', 'Support'],
        slot1Weapon: {
          bestInSlot: 'Papal Crosier',
          optimalAlternatives: ['Sacral Rod', 'Hallowed Staff', 'Euros\'s Staff'],
          slotType: 'Weapon',
          notes: 'Mag Atk +26, Healing +20%, AP +1. Scarlett\'s sacred relic.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Scarlett\'s Ribbon',
          optimalAlternatives: ['Archbishop\'s Mitre', 'Silk Hood', 'Holy Brooch'],
          slotType: 'Accessory',
          notes: 'Healing +20, Mag Def +8, PP +1, Grants Quick Heal.'
        },
        slot3Accessory: {
          bestInSlot: 'Ring of the Maiden',
          optimalAlternatives: ['Holy Unicorn Signet', 'Celestial Talisman', 'Saint\'s Brooch'],
          slotType: 'Accessory',
          notes: 'Mag Def +10, AP +1, PP +1, Maiden\'s Protection, All Affliction Immunity.'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'First Aid Kit', 'Vitality Talisman'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Meteorite Lance', 'Dragonbone Spear', 'General\'s Pike'],
          slotType: 'Weapon',
          notes: 'Phys Atk +25, AP +1.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Chivalric Shield',
          optimalAlternatives: ['Steel Shield', 'Azure Crest Shield', 'Knight\'s Shield'],
          slotType: 'Shield',
          notes: 'Phys Def +6, Guard Rate +25%, Stun/Guard Seal Immunity.'
        },
        slot3Accessory: {
          bestInSlot: 'Heavensteed Reins',
          optimalAlternatives: ['Cavalry Hunter\'s Buckler', 'Warrior\'s Medallion', 'Knight\'s Brooch'],
          slotType: 'Accessory',
          notes: 'Cavalry Attack +15%, Guard Rate +10%, Grants Dynamic Glide.'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Power Belt', 'Critical Talisman'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        growthTypes: ['Support', 'Go-Getter'],
        slot1Weapon: {
          bestInSlot: 'General\'s Pike',
          optimalAlternatives: ['Meteorite Lance', 'Sacral Spear', 'Iron Lance'],
          slotType: 'Weapon',
          notes: 'Phys Atk +22, Initiative +4, True Strike.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Dancer\'s Bracelet',
          optimalAlternatives: ['Silk Hood', 'Verdant Ribbon', 'Silk Scarf'],
          slotType: 'Accessory',
          notes: 'Phys Def +1, Mag Def +1, Grants Powerful Call (+20% Phys Atk to ally).'
        },
        slot3Accessory: {
          bestInSlot: 'Verdant Ribbon',
          optimalAlternatives: ['Lapis Bell', 'Raven Plume', 'Commander\'s Crest'],
          slotType: 'Accessory',
    ...
    tacticsSequence: [
      { step: 1, unit: 'Chloe', skill: 'Keen Call', condition1: '[Target: Highest ATK Cavalry Ally]', condition2: '[Self PP >= 1]', notes: 'Buffs Alain and Clive with 100% Guaranteed Critical Strike.' },
      { step: 2, unit: 'Alain', skill: 'Spinning Edge', condition1: '[Target: Front Row (2+ Enemies)]', condition2: '[Self AP >= 2]', notes: 'Row-cleaving physical assault dealing massive damage.' },
      { step: 3, unit: 'Clive', skill: 'Wild Rush', condition1: '[Target: Column (Infantry Priority)]', condition2: '[Self AP >= 2]', notes: 'Column-piercing charge knocking back infantry defenders.' },
      { step: 4, unit: 'Melisandre', skill: 'Meteor Slash', condition1: '[Target: Scout / Evasive Enemy]', condition2: '[Self AP >= 2]', notes: '9-hit true strike deleting evasive backline threats.' },
      { step: 5, unit: 'Scarlett', skill: 'Holy Light', condition1: '[Target: Lowest HP % Enemy]', condition2: '[Self AP >= 1]', notes: 'Magic finisher bypassing heavy physical armor.' }
    ]
  },

  // ============================================================================
  // SQUAD 2: Trinity Rain Instant Apocalypse
  // ============================================================================
  {
    ...
    frontRow: ['hodrick-legionnaire', 'selvie-druid'],
    backRow: ['auch-sorcerer', 'yahna-sorceress', 'sharon-bishop'],
    keyItems: ['Millenium Scepter', 'Black Cat-Ear Hood', 'Sniper\'s Amber Lens', 'Familiar\'s Choker'],
    counters: ['Armored formations', 'Physical dodge tanks', 'Ground infantry'],
    strategyGuide: {
    ...
    unitGearConfigs: [
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Grand Magus Staff', 'Carnelian Staff', 'Sacral Rod'],
          slotType: 'Weapon',
          notes: 'Trinity Rain 4 AP, Mag Atk +25, Mag Def +8.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Sage\'s Hood',
          optimalAlternatives: ['Silk Hood', 'Wizard\'s Hat', 'Sorcerer\'s Robes'],
          slotType: 'Accessory',
          notes: 'Mag Atk +5, Mag Def +5, Initiative +4.'
        },
        slot3Accessory: {
          bestInSlot: 'Sniper\'s Amber Lens',
          optimalAlternatives: ['Sniper\'s Lens', 'Eyepatch of True Sight', 'Critical Ring'],
          slotType: 'Accessory',
          notes: 'Grants Hawk Eye: Guaranteed 100% Crit + True Strike on Trinity Rain.'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Sapphire Pendant', 'Magick Brooch'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Sacral Rod', 'Hallowed Staff', 'Cleric\'s Cane'],
          slotType: 'Weapon',
          notes: 'Mag Atk +25, Initiative +5.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Black Cat-Ear Hood',
          optimalAlternatives: ['White Cat-Ear Hood', 'Archbishop\'s Mitre', 'Silk Hood'],
          slotType: 'Accessory',
        ...
        slot4Accessory: {
          ...
          optimalAlternatives: ['Lapis Pendant', 'Raven Plume', 'Saint\'s Talisman'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        growthTypes: ['Offensive', 'Go-Getter'],
        slot1Weapon: {
          bestInSlot: 'Carnelian Staff',
          optimalAlternatives: ['Dustbound Staff', 'Grand Magus Staff', 'Runic Staff'],
          slotType: 'Weapon',
          notes: 'Mag Atk +25, AP +1.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Silk Hood',
          optimalAlternatives: ['Sage\'s Hood', 'Sorceress Robes', 'Magick Brooch'],
          slotType: 'Accessory',
          notes: 'Mag Def +4, Initiative +3.'
        },
        slot3Accessory: {
          bestInSlot: 'Familiar\'s Choker',
          optimalAlternatives: ['Sorcerer\'s Medallion', 'Magick Pendant', 'Crown of Wisdom'],
          slotType: 'Accessory',
          notes: 'Sorcerous Connection: +50% Magic Attack to Auch.'
        },
        slot4Accessory: {
          bestInSlot: 'Raven Plume',
          optimalAlternatives: ['Angel Plume', 'Wind Talisman', 'Speed Belt'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        growthTypes: ['Guardian', 'Survivor'],
        slot1Weapon: {
          bestInSlot: 'Zenoiran Spear',
          optimalAlternatives: ['Meteorite Lance', 'Dragonbone Spear', 'Heavy Lance'],
          slotType: 'Weapon',
          notes: 'Phys Atk +22, Guard Rate +15%.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Unyielding Shield',
          optimalAlternatives: ['Azure Crest Shield', 'Golden Ram Shield', 'Steel Shield'],
          slotType: 'Shield',
          notes: 'Greatshield Slot: Phys Def +7, Enduring Guard, Guard Rate +45%, Max HP +20.'
        },
        slot3Accessory: {
          bestInSlot: 'Defensive Ring',
          optimalAlternatives: ['Guardian Gloves', 'Tower Shield Belt', 'Vitality Talisman'],
          slotType: 'Accessory',
          notes: 'Phys Def +5, Guard Rate +10%, Grants Quick Barrier.'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Heavy Armor Brooch', 'First Aid Kit'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Chiropteran Staff', 'Flame-Hex Staff', 'Sacral Rod'],
          slotType: 'Weapon',
          notes: 'Sandstorm: Start of Battle Blindness.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Druid\'s Robes',
          optimalAlternatives: ['Dusk Robes', 'Silk Hood', 'Curse Brooch'],
          slotType: 'Accessory',
          notes: 'Mag Def +10, Initiative +6, Debuff Resistance +50%.'
        },
        slot3Accessory: {
          bestInSlot: 'Raven Plume',
          optimalAlternatives: ['Angel Plume', 'Wind Brooch', 'Speed Amulet'],
          slotType: 'Accessory',
          notes: 'Initiative +15 to ensure Turn-0 curse application.'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Cursed Talisman', 'Vitality Talisman'],
          slotType: 'Accessory',
    ...
    tacticsSequence: [
      { step: 1, unit: 'Selvie', skill: 'Sandstorm', condition1: '[Start of Battle]', condition2: '[Target: All Enemies]', notes: 'Turn-0 Blindness preventing enemy physical burst.' },
      { step: 2, unit: 'Yahna', skill: 'Sorcerous Connection', condition1: '[Before Ally Magic Attack]', condition2: '[Self PP >= 1]', notes: 'Grants +50% Magic Attack to Auch.' },
      { step: 3, unit: 'Auch', skill: 'Trinity Rain', condition1: '[Target: All Enemies (Turn 1)]', condition2: '[Self AP >= 4]', notes: 'Charges 3-hit catastrophic battlefield wipe.' },
      { step: 4, unit: 'Sharon', skill: 'Quick Impetus', condition1: '[Target: Auch (After Charge)]', condition2: '[Self PP >= 3]', notes: 'Instant turn reset allowing Trinity Rain to trigger immediately.' },
      { step: 5, unit: 'Hodrick', skill: 'Heavy Cover', condition1: '[Before Ally Attacked (Back Row)]', condition2: '[Self PP >= 1]', notes: '100% physical mitigation protecting squishy spellcasters.' }
    ]
  },

  // ============================================================================
  // SQUAD 3: Dragoon Glacial Tempest
  // ============================================================================
  {
    ...
    frontRow: ['hilda-wyvern-master', 'fran-gryphon-master'],
    backRow: ['miriam-sainted-knight', 'primm-bishop', 'gilbert-prince'],
    keyItems: ['Dragoon\'s Warspear', 'White Cat-Ear Hood', 'Heavenwyvern Reins', 'Royal Saber'],
    counters: ['Cavalry squads', 'Low P.Def infantry', 'Armored frontline walls'],
    strategyGuide: {
    ...
    unitGearConfigs: [
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Meteorite Lance', 'Carnelian Spear', 'Dragonbone Spear'],
          slotType: 'Weapon',
          notes: 'Dragoon Dive 4 AP, Phys Atk +24, Initiative +5.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Wyvern Reins',
          optimalAlternatives: ['Heavensteed Reins', 'Winged Brooch', 'Flight Scarf'],
          slotType: 'Accessory',
          notes: 'Flying Atk +10%, Initiative +5, Grants Aerial Wing.'
        },
        slot3Accessory: {
          bestInSlot: 'Hero\'s Medallion',
          optimalAlternatives: ['Warrior\'s Medallion', 'Critical Talisman', 'Sniper\'s Lens'],
          slotType: 'Accessory',
          notes: 'Phys Atk +20%, Base AP +1, Base PP +1. Coliseum Champion Crown.'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Power Belt', 'Vitality Talisman'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Carnelian Axe', 'Meteorite Axe', 'Rose Knight Axe'],
          slotType: 'Weapon',
          notes: 'Phys Atk +26, Initiative +5, Crit +10%.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Heavenwyvern Reins',
          optimalAlternatives: ['Wyvern Reins', 'Flight Brooch', 'Wind Talisman'],
          slotType: 'Accessory',
          notes: 'Flying Atk +15%, Initiative +10, Grants Aerial Wing.'
        },
        slot3Accessory: {
          bestInSlot: 'Wingline Standard',
          optimalAlternatives: ['Angel Plume', 'Feather Brooch', 'Gryphon Crest'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        growthTypes: ['Support', 'Guardian'],
        slot1Weapon: {
          bestInSlot: 'Runic Sword',
          optimalAlternatives: ['Rosularis Sword', 'Hallowed Blade', 'White Knight Blade'],
          slotType: 'Weapon',
          notes: 'Phys Atk +8, Mag Atk +14, Magick Attack, Mag Def +3.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Luminous Shield',
          optimalAlternatives: ['Holy Knight\'s Shield', 'Azure Crest Shield', 'Steel Shield'],
          slotType: 'Shield',
          notes: 'Phys Def +6, Poison/Blindness Immunity, Guard Rate +25%.'
        },
        slot3Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Magick Brooch', 'Celestial Talisman'],
          slotType: 'Accessory',
          notes: 'PP +1 for Magic Barrier triggers.'
        },
        slot4Accessory: {
          bestInSlot: 'First Aid Kit',
          optimalAlternatives: ['Vitality Talisman', 'Healing Brooch', 'Saint\'s Talisman'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Sacral Rod', 'Euros\'s Staff', 'Cleric\'s Cane'],
          slotType: 'Weapon',
          notes: 'Mag Atk +22, HP Regen +10%.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'White Cat-Ear Hood',
          optimalAlternatives: ['Black Cat-Ear Hood', 'Archbishop\'s Mitre', 'Silk Hood'],
          slotType: 'Accessory',
        ...
        slot4Accessory: {
          bestInSlot: 'Sapphire Pendant',
          optimalAlternatives: ['Lapis Pendant', 'Raven Plume', 'Saint\'s Brooch'],
          slotType: 'Accessory',
          notes: 'PP +2 ensuring total PP >= 4.'
        }
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Kingsblade Cornix', 'Notos\'s Sword', 'General\'s Saber'],
          slotType: 'Weapon',
          notes: 'Phys Atk +18, Initiative +5. Gilbert\'s royal command blade.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Royal Scarf',
          optimalAlternatives: ['Prince\'s Crown', 'Silk Scarf', 'Commander\'s Crest'],
          slotType: 'Accessory',
          notes: 'Initiative +5, Evasion +10.'
        },
        slot3Accessory: {
          bestInSlot: 'Angel Plume',
          optimalAlternatives: ['Raven Plume', 'Wind Brooch', 'Royal Medallion'],
          slotType: 'Accessory',
          notes: 'Tailwind Array: Start of Battle +20 Squad Initiative.'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Vitality Talisman', 'First Aid Kit'],
          slotType: 'Accessory',
    ...
    tacticsSequence: [
      { step: 1, unit: 'Gilbert', skill: 'Rapid Order', condition1: '[Start of Battle]', condition2: '[Self PP >= 1]', notes: 'Grants +20 Initiative to entire squad guaranteeing turn priority.' },
      { step: 2, unit: 'Gilbert', skill: 'Offensive Order', condition1: '[Target: Back Row Allies]', condition2: '[Self PP >= 1]', notes: 'Increases Hilda\'s physical attack power by 20%.' },
      { step: 3, unit: 'Hilda', skill: 'Dragoon Dive', condition1: '[Target: Full Row (3+ Enemies)]', condition2: '[Self AP >= 4]', notes: 'Launches skyward for devastating 300 potency dive bomb.' },
      { step: 4, unit: 'Primm', skill: 'Quick Impetus', condition1: '[Target: Hilda (After Charge)]', condition2: '[Self PP >= 3]', notes: 'Instantly grants 100% turn bar to crash down on Turn 1.' },
      { step: 5, unit: 'Fran', skill: 'High Gale', condition1: '[Target: Cavalry / Front Row]', condition2: '[Self AP >= 2]', notes: 'Sweeps surviving cavalry and infantry with 2x damage.' }
    ]
  },

  // ============================================================================
  // SQUAD 4: Berengaria Affliction & Death Spiral
  // ============================================================================
  {
    ...
    frontRow: ['berengaria-renegade', 'travis-rogue'],
    backRow: ['nina-breaker', 'liza-shieldshooter', 'bruno-berserker'],
    keyItems: ['Carnelian Axe', 'Kaikias\'s Shield', 'Earrings of Pursuit', 'Pursuant\'s Blade', 'Lucky Coin'],
    counters: ['Physical frontline tanks', 'Scouts and evasion units', 'Unshielded backlines'],
    strategyGuide: {
    ...
    unitGearConfigs: [
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Meteorite Axe', 'Dragonbone Axe', 'Boreas\'s Axe'],
          slotType: 'Weapon',
          notes: 'Phys Atk +25, AP +1.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Kaikias\'s Shield',
          optimalAlternatives: ['Zenoiran Shield', 'Chivalric Shield', 'Steel Shield', 'Battler\'s Shield'],
          slotType: 'Shield',
          notes: 'Phys Def +8, Guard Rate +30%, Guard Efficiency +25%, Initiative +10.'
        },
        slot3Accessory: {
          bestInSlot: 'Earrings of Pursuit',
          optimalAlternatives: ['Warrior\'s Medallion', 'Veteran\'s Eyepatch', 'Counter Belt'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        growthTypes: ['Keen', 'Go-Getter'],
        slot1Weapon: {
          bestInSlot: 'Pursuant\'s Blade',
          optimalAlternatives: ['Venom Blade', 'Notos\'s Sword', 'Bandit Longsword'],
          slotType: 'Weapon',
          notes: 'Phys Atk +18, Grants Pursuit (1 PP).'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Thief\'s Mantle',
          optimalAlternatives: ['Illusory Cloak', 'Dusk Robes', 'Silk Scarf'],
          slotType: 'Accessory',
          notes: 'Evasion +20, Grants Evade (1 PP).'
        },
        slot3Accessory: {
          bestInSlot: 'Lucky Coin',
          optimalAlternatives: ['Evasion Ring', 'Raven Plume', 'Wind Brooch'],
          slotType: 'Accessory',
          notes: 'Evasion +20, Crit Rate +20% for frontline evasion tanking.'
        },
        slot4Accessory: {
          bestInSlot: 'Raven Plume',
          optimalAlternatives: ['Angel Plume', 'Speed Belt', 'Wind Talisman'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Mason\'s Hammer', 'Rose Knight Hammer', 'Meteorite Axe'],
          slotType: 'Weapon',
          notes: 'Phys Atk +26, Stun Multiplier, Grants Ground Strike.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Master\'s Gauntlets',
          optimalAlternatives: ['Armored Gauntlets', 'Power Belt', 'Warrior\'s Medallion'],
          slotType: 'Accessory',
          notes: 'Phys Atk +5, Guard Pierce +10%, Grants Nimble Fighter.'
        },
        slot3Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Critical Ring', 'Vitality Talisman'],
          slotType: 'Accessory',
          notes: 'PP +1 for Heavy Impact.'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Power Belt', 'Strength Brooch'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Zenoiran Bow', 'Runic Bow', 'Dragonbone Bow'],
          slotType: 'Weapon',
          notes: 'Phys Atk +25, Initiative +5, True Strike.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Sniper\'s Lens',
          optimalAlternatives: ['Mirrored Spectacles', 'Hunter\'s Cap', 'Veteran\'s Eyepatch'],
          slotType: 'Accessory',
          notes: 'Crit Rate +10%, Acc +15, Grants Eagle Eye.'
        },
        slot3Accessory: {
          bestInSlot: 'Mirrored Spectacles',
          optimalAlternatives: ['Veteran\'s Eyepatch', 'Warrior\'s Medallion', 'Raven Plume'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        growthTypes: ['Offensive', 'Survivor'],
        slot1Weapon: {
          bestInSlot: 'Dragonbone Axe',
          optimalAlternatives: ['Meteorite Axe', 'Carnelian Axe', 'Boreas\'s Axe'],
          slotType: 'Weapon',
          notes: 'Phys Atk +22, PP +1.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Power Belt',
          optimalAlternatives: ['Warrior\'s Medallion', 'Armored Gauntlets', 'Brawler Ring'],
          slotType: 'Accessory',
        ...
        slot4Accessory: {
          ...
          optimalAlternatives: ['Ruby Pendant', 'Lifeblood Talisman', 'Survivor Ring'],
          slotType: 'Accessory',
    ...
    tacticsSequence: [
      { step: 1, unit: 'Berengaria', skill: 'Eye of the Crimson Bear', condition1: '[Start of Battle]', condition2: '[Self PP >= 1]', notes: 'Inflicts -15 Initiative and -20% Attack on all enemies.' },
      { step: 2, unit: 'Travis', skill: 'Shadowbite', condition1: '[Target: Front Row (2+ Enemies)]', condition2: '[Self AP >= 2]', notes: 'Blinds enemy frontline and seals passive reactions.' },
      { step: 3, unit: 'Berengaria', skill: 'Death Spin', condition1: '[Target: Front Row (Afflicted)]', condition2: '[Self AP >= 2]', notes: 'Row-cleave axe spin dealing +50% bonus damage to blinded targets.' },
      { step: 4, unit: 'Berengaria', skill: 'Sanguine Pursuit', condition1: '[After Ally Attacks]', condition2: '[Self PP >= 1]', notes: 'Executes follow-up strike restoring +1 AP on kill.' },
      { step: 5, unit: 'Nina', skill: 'Heavy Impact', condition1: '[Target: Armored / Guarding Enemy]', condition2: '[Self AP >= 2]', notes: 'Shatters enemy heavy shields with 100% guard pierce.' }
    ]
  },

  // ============================================================================
  // SQUAD 5: Virginia Valkyrian Counter Fortress (DUAL SHIELD MASTER)
  // ============================================================================
  {
    ...
    frontRow: ['virginia-valkyria', 'colm-vanguard'],
    backRow: ['leah-swordmaster', 'kitra-breaker', 'liza-shieldshooter'],
    keyItems: ['Blue Rose Sword', 'Blue Rose Shield', 'Parrying Shield', 'Gallian Crossbow', 'First Aid Kit'],
    counters: ['Multi-hit physical attackers', 'Swordmasters', 'Cavalry chargers', 'Flying attackers'],
    strategyGuide: {
    ...
    unitGearConfigs: [
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Rosularis Sword', 'Kingsblade Cornix', 'Meteorite Sword'],
          slotType: 'Weapon',
        ...
        slot3Accessory: {
          ...
          optimalAlternatives: ['Zenoiran Shield', 'Counter Belt', 'Tower Shield', 'Azure Crest Shield'],
          slotType: 'Shield',
          notes: 'Dual-Shield Slot: Phys Def +2, Parry, Guard Rate +25%, Counter Skills Deal +50 Damage.'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Vitality Talisman', 'Strength Brooch'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Zenoiran Sword', 'Iron Sword', 'Bronze Sword'],
          slotType: 'Weapon',
          notes: 'Phys Atk +24, Max HP +20, Guard +10%.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Arrowshield',
          optimalAlternatives: ['Battler\'s Shield', 'Steel Shield', 'Guard\'s Shield'],
          slotType: 'Shield',
          notes: 'Phys Def +2, Arrow Cover, Guard Rate +25%.'
        },
        slot3Accessory: {
          bestInSlot: 'First Aid Kit',
          optimalAlternatives: ['Defender\'s Ring', 'Guardian Gloves', 'Vitality Talisman'],
          slotType: 'Accessory',
          notes: 'Grants Quick Heal (50% HP heal to frontline ally) for emergency sustain.'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Knight\'s Crest', 'Defender\'s Ring'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Kingsblade Cornix', 'Meteorite Sword', 'General\'s Saber'],
          slotType: 'Weapon',
          notes: 'Main-Hand Slot: Phys Atk +25, Initiative +5.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Flamberge',
          optimalAlternatives: ['Black-Iron Sword', 'Pursuant\'s Blade', 'Vorpal Sword'],
          slotType: 'Weapon',
          notes: 'Dual-Wield Off-Hand Slot: Phys Atk +21, Burn Immunity, Grants Grisly Fire.'
        },
        slot3Accessory: {
          bestInSlot: 'Retaliation Earrings',
          optimalAlternatives: ['Parrying Amulet', 'Warrior\'s Medallion', 'Evasion Ring'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Juggernaut', 'Mason\'s Hammer', 'Meteorite Axe'],
          slotType: 'Weapon',
          notes: 'Phys Atk +15, Initiative +3, Accuracy +10.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Armored Gauntlets',
          optimalAlternatives: ['Master\'s Gauntlets', 'Power Belt', 'Warrior\'s Medallion'],
          slotType: 'Accessory',
          notes: 'Phys Atk +4, Phys Def +4, Grants Binding Guard.'
        },
        slot3Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Strength Brooch', 'Power Belt'],
          slotType: 'Accessory',
          notes: 'AP +1 for Enraged Strike armor crushes.'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Vitality Talisman', 'Critical Ring'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        growthTypes: ['Guardian', 'Support'],
        slot1Weapon: {
          bestInSlot: 'Gallian Crossbow',
          optimalAlternatives: ['Zenoiran Bow', 'Apeliotes\'s Bow', 'Runic Bow'],
          slotType: 'Weapon',
          notes: 'Phys Atk +24, Anti-Flying 200%, Grants Harpoon Bolt.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Zenoiran Knight\'s Shield',
          optimalAlternatives: ['Unyielding Shield', 'Azure Crest Shield', 'Steel Shield'],
          slotType: 'Shield',
        ...
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Guardian Gloves', 'Defender\'s Ring'],
          slotType: 'Accessory',
    ...
    tacticsSequence: [
      { step: 1, unit: 'Virginia', skill: 'Iron Veil', condition1: '[Start of Battle]', condition2: '[Self PP >= 1]', notes: 'Grants +50% Physical Defense to entire squad.' },
      { step: 2, unit: 'Liza', skill: 'First Aid', condition1: '[After Ally Attacked]', condition2: '[Target: Ally HP <= 75%]', notes: 'Automatically casts 50% HP reactive heal on Virginia or Colm when attacked.' },
      { step: 3, unit: 'Colm', skill: 'Arrow Cover', condition1: '[Before Ally Attacked (Ranged)]', condition2: '[Self PP >= 1]', notes: 'Negates 100% ranged and flying projectile damage.' },
      { step: 4, unit: 'Virginia', skill: 'Maiden\'s Hammer', condition1: '[Target: Armored / Guarding Enemy]', condition2: '[Self AP >= 2]', notes: 'Heavy armor-piercing strike ignoring enemy defense.' },
      { step: 5, unit: 'Leah', skill: 'Meteor Slash', condition1: '[Target: Lowest HP % Enemy]', condition2: '[Self AP >= 2]', notes: '9-hit flurry tearing through softened targets.' }
    ]
  },

  // ============================================================================
  // SQUAD 6: Yunifi Glacial Rain Absolute Zero
  // ============================================================================
  {
    ...
    frontRow: ['bryce-legionnaire', 'lex-vanguard'],
    backRow: ['yunifi-snow-ranger', 'ramona-wereowl', 'ridiel-elven-archer'],
    keyItems: ['Zenoiran Bow', 'Celestial Talisman', 'Glacial Ring', 'Lapis Bell', 'Sage Owl\'s Shawl'],
    counters: ['Melee infantry squads', 'High speed burst formations', 'Clustered frontlines'],
    strategyGuide: {
    ...
    unitGearConfigs: [
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Meteorite Bow', 'Apeliotes\'s Bow', 'Dragonbone Bow'],
          slotType: 'Weapon',
          notes: 'Phys Atk +24, Crit Rate +10%, Anti-Flying. Authentic Zenoiran longbow.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Celestial Talisman',
          optimalAlternatives: ['Sniper\'s Amber Lens', 'Silken Scarf', 'Thief\'s Mantle'],
          slotType: 'Accessory',
        ...
        slot4Accessory: {
          ...
          optimalAlternatives: ['Lucky Coin', 'Raven Plume', 'Sniper\'s Amber Lens'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot2ShieldOrOffhand: {
          ...
          optimalAlternatives: ['Archbishop\'s Mitre', 'Silk Hood', 'Shawl of Repose'],
          slotType: 'Accessory',
          notes: 'Mag Def +8, Initiative +6, Grants Quick Dispel.'
        },
        slot3Accessory: {
          bestInSlot: 'Lapis Bell',
          optimalAlternatives: ['Lapis Pendant', 'White Ribbon', 'Sapphire Pendant'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        growthTypes: ['Support', 'Offensive'],
        slot1Weapon: {
          bestInSlot: 'Runic Bow',
          optimalAlternatives: ['Sacral Bow', 'Apeliotes\'s Bow', 'Elven Bow'],
          slotType: 'Weapon',
          notes: 'Phys Atk +8, Mag Atk +14, Magick Attack.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Silver Circlet',
          optimalAlternatives: ['Dream Crown', 'Silk Hood', 'Magick Brooch'],
          slotType: 'Accessory',
          notes: 'Mag Atk +5, Mag Def +5, PP +1.'
        },
        slot3Accessory: {
          bestInSlot: 'Clearsight Amulet',
          optimalAlternatives: ['First Aid Kit', 'Lapis Pendant', 'White Ribbon'],
          slotType: 'Accessory',
          notes: 'Mag Def +1, Blindness Immunity, guarantees archer accuracy.'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Raven Plume', 'Vitality Talisman'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Zenoiran Spear', 'Carnelian Spear', 'Dragonbone Spear'],
          slotType: 'Weapon',
          notes: 'Phys Atk +24, Max HP +20.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Golden Ram Shield',
          optimalAlternatives: ['Azure Crest Shield', 'Unyielding Shield', 'Steel Shield'],
          slotType: 'Shield',
          notes: 'Greatshield Slot: Phys Def +5, Max HP +10, Stun Immunity, Guard Rate +25%.'
        },
        slot3Accessory: {
          bestInSlot: 'Guardian Gloves',
          optimalAlternatives: ['Defensive Ring', 'Armored Gauntlets', 'Vitality Talisman'],
          slotType: 'Accessory',
          notes: 'Guard Rate +15%, Grants Guarding Fighter.'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Tower Shield Belt', 'First Aid Kit'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Meteorite Sword', 'Iron Sword', 'Bronze Sword'],
          slotType: 'Weapon',
          notes: 'Phys Atk +22, Phys Def +5.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Battler\'s Shield',
          optimalAlternatives: ['Arrowshield', 'Parrying Shield', 'Steel Shield'],
          slotType: 'Shield',
          notes: 'Phys Def +2, Phys Atk +2, Guard Rate +25%.'
        },
        slot3Accessory: {
          bestInSlot: 'Warrior\'s Medallion',
          optimalAlternatives: ['Defender\'s Ring', 'Power Belt', 'Vitality Talisman'],
          slotType: 'Accessory',
          notes: 'Phys Atk +3, Guard Rate +10%.'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'First Aid Kit', 'Speed Belt'],
          slotType: 'Accessory',
    ...
    tacticsSequence: [
      { step: 1, unit: 'Yunifi', skill: 'Glacial Rain', condition1: '[Target: All Enemies (Turn 1)]', condition2: '[Self AP >= 4]', notes: 'Freezes entire enemy formation in ice.' },
      { step: 2, unit: 'Ramona', skill: 'Restore', condition1: '[Target: Ally using Active Skill]', condition2: '[Self PP >= 1]', notes: 'Restores 1 PP to Yunifi / Ridiel upon action.' },
      { step: 3, unit: 'Ridiel', skill: 'Mystic Conferral', condition1: '[Before Ally Magic / Phys Attack]', condition2: '[Self PP >= 1]', notes: 'Enchants attacks with bonus magic damage.' },
      { step: 4, unit: 'Bryce', skill: 'Heavy Cover', condition1: '[Before Ally Attacked (Back Row)]', condition2: '[Self PP >= 1]', notes: 'Soaks physical strikes targeting backline.' },
      { step: 5, unit: 'Lex', skill: 'Arrow Cover', condition1: '[Before Ally Attacked (Ranged)]', condition2: '[Self PP >= 1]', notes: 'Absorbs and negates enemy ranged arrows.' }
    ]
  },

  // ============================================================================
  // SQUAD 7: Elven Twin Sisters Elemental Tempest
  // ============================================================================
  {
    ...
    frontRow: ['ithilion-elven-fencer', 'railanor-elven-fencer'],
    backRow: ['rosalinde-elven-augur', 'eltolinde-elven-sibyl', 'galadmir-elven-archer'],
    keyItems: ['Sacral Spear', 'Kingslance Elhal', 'Ancient Crown', 'Dream Crown'],
    counters: ['Heavy armored walls', 'Infantry ground formations', 'Mixed hybrid defenses'],
    strategyGuide: {
    ...
    unitGearConfigs: [
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Kingslance Elhal', 'Carnelian Spear', 'Dragonbone Spear'],
          slotType: 'Weapon',
          notes: 'Phys Atk +25, Affliction Immunity, Heal 20% HP on active skill.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Ancient Crown',
          optimalAlternatives: ['Dream Crown', 'Silk Hood', 'Silver Circlet'],
          slotType: 'Accessory',
          notes: 'Mag Atk +8, Mag Def +8, PP +1, Initiative +5.'
        },
        slot3Accessory: {
          bestInSlot: 'Old Witch\'s Ring',
          optimalAlternatives: ['Old Witch\'s Ring', 'Celestial Talisman', 'Raven Plume'],
          slotType: 'Accessory',
          notes: 'Mag Def +3, Magick Conversion, Mag Atk +2.'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Sapphire Pendant', 'Vitality Talisman'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Sacral Spear', 'Meteorite Lance', 'Runic Spear'],
          slotType: 'Weapon',
          notes: 'Phys Atk +28, All Stats +5. Eltolinde\'s royal Elheim lance.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Dream Crown',
          optimalAlternatives: ['Ancient Crown', 'Silk Hood', 'Silver Circlet'],
          slotType: 'Accessory',
          notes: 'Mag Atk +6, Mag Def +6, PP +1.'
        },
        slot3Accessory: {
          bestInSlot: 'Elite Standard',
          optimalAlternatives: ['Celestial Talisman', 'Lapis Pendant', 'First Aid Kit'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Spellsteel Sword', 'Runic Sword', 'Notos\'s Sword'],
          slotType: 'Weapon',
          notes: 'Mag Atk +22, Mag Def +5, Initiative +3, Grants Phantom Attack.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Illusory Cloak',
          optimalAlternatives: ['Thief\'s Mantle', 'Dusk Robes', 'Silk Scarf'],
          slotType: 'Accessory',
          notes: 'Evasion +20, Grants Phantom Step.'
        },
        slot3Accessory: {
          bestInSlot: 'Raven Plume',
          optimalAlternatives: ['Angel Plume', 'Wind Brooch', 'Evasion Ring'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Runic Sword', 'Phantom Knight\'s Sword', 'Zephyrus Sword'],
          slotType: 'Weapon',
          notes: 'Phys Atk +18, Mag Atk +16, Evasion +10.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Dusk Robes',
          optimalAlternatives: ['Illusory Cloak', 'Silk Hood', 'Evasion Scarf'],
          slotType: 'Accessory',
          notes: 'Mag Def +12, Evasion +10, Grants Nocturnal Impetus.'
        },
        slot3Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Raven Plume', 'Wind Talisman'],
          slotType: 'Accessory',
          notes: 'PP +1 for Mirage Step dodges.'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Critical Talisman', 'Power Belt'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Runic Bow', 'Apeliotes\'s Bow', 'Dragonbone Bow'],
          slotType: 'Weapon',
          notes: 'Phys Atk +25, Affliction Immunity, Heal 20% HP on active skill.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Silk Hood',
          optimalAlternatives: ['Elven Tiara', 'Dream Crown', 'Magick Brooch'],
          slotType: 'Accessory',
          notes: 'Mag Def +4, Initiative +3.'
        },
        slot3Accessory: {
          bestInSlot: 'Detoxifying Amulet',
          optimalAlternatives: ['Celestial Talisman', 'First Aid Kit', 'Lapis Pendant'],
          slotType: 'Accessory',
    ...
    tacticsSequence: [
      { step: 1, unit: 'Rosalinde', skill: 'Rage of the Faeries', condition1: '[Start of Battle]', condition2: '[Self PP >= 1]', notes: 'Stuns enemy front row at the start of battle.' },
      { step: 2, unit: 'Eltolinde', skill: 'Boon of the Faeries', condition1: '[Start of Battle]', condition2: '[Self PP >= 1]', notes: 'Deploys 1-hit complete damage nullification barrier to entire squad.' },
      { step: 3, unit: 'Rosalinde', skill: 'Elemental Roar', condition1: '[Target: All Enemies]', condition2: '[Self AP >= 3]', notes: 'Fires massive hybrid physical/magic full-board strike.' },
      { step: 4, unit: 'Eltolinde', skill: 'Elemental Roar', condition1: '[Target: All Enemies]', condition2: '[Self AP >= 3]', notes: 'Follows up with second full-board elemental wipe.' },
      { step: 5, unit: 'Ithilion', skill: 'Lightning Sword', condition1: '[Target: Scout / Evasion Enemy]', condition2: '[Self AP >= 1]', notes: 'Stuns and destroys remaining high-evasion survivors.' }
    ]
  },

  // ============================================================================
  // SQUAD 8: Amalia Colossal Shield & Armor Obliteration
  // ============================================================================
  {
    ...
    frontRow: ['amalia-dreadnought', 'bertrand-werebear'],
    backRow: ['monica-sainted-knight', 'aramis-swordmaster', 'mandrin-sniper'],
    keyItems: ['Mason\'s Hammer', 'Azure Crest Shield', 'Greatwood Greataxe', 'Riot Belt'],
    counters: ['Legionnaires and armored walls', 'Boss targets', 'Single vanguard units'],
    strategyGuide: {
    ...
    unitGearConfigs: [
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Dragonbone Sword', 'Kingsblade Cornix', 'Meteorite Sword'],
          slotType: 'Weapon',
          notes: 'Phys Atk +28, Guard Piercing +50%, Grants Powerful Impact.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Azure Crest Shield',
          optimalAlternatives: ['Holy Unicorn Shield', 'Chivalric Shield', 'Steel Shield'],
          slotType: 'Shield',
          notes: 'Greatshield Slot: Phys Def +5, Base PP +1, Guard Rate +25%.'
        },
        slot3Accessory: {
          bestInSlot: 'Riot Belt',
          optimalAlternatives: ['Power Belt', 'Warrior\'s Medallion', 'Counter Belt'],
          slotType: 'Accessory',
          notes: 'Phys Atk +20%, Grants Wide Counter.'
        },
        slot4Accessory: {
          bestInSlot: 'Carnelian Pendant',
          optimalAlternatives: ['Ruby Pendant', 'Strength Brooch', 'Vitality Talisman'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Boreas\'s Axe', 'Dragonbone Axe', 'Meteorite Axe'],
          slotType: 'Weapon',
          notes: 'Phys Atk +24, Mag Def +4, Guard +10%.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Beast Hunter\'s Buckler',
          optimalAlternatives: ['Ironclad Buckler', 'Unyielding Shield', 'Golden Ram Shield'],
          slotType: 'Shield',
          notes: 'Greatshield Slot: Phys Def +6, Bestral Guard, Guard Rate +25%.'
        },
        slot3Accessory: {
          bestInSlot: 'Lifeblood Talisman',
          optimalAlternatives: ['Ruby Pendant', 'Vitality Talisman', 'Survivor Ring'],
          slotType: 'Accessory',
          notes: 'Max HP +20, Indomitable Guard synergy.'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Heavy Armor Belt', 'First Aid Kit'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Runic Sword', 'Hallowed Blade', 'White Knight Blade'],
          slotType: 'Weapon',
          notes: 'Phys Atk +25, Base PP +1, HP Recovery +30%.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Holy Knight\'s Shield',
          optimalAlternatives: ['Luminous Shield', 'Azure Crest Shield', 'Steel Shield'],
          slotType: 'Shield',
      ...
      },
      {
        ...
        slot2ShieldOrOffhand: {
          ...
          optimalAlternatives: ['Vorpal Sword', 'Venom Blade', 'Pursuant\'s Blade'],
          slotType: 'Weapon',
          notes: 'Dual-Wield Off-Hand Slot: Phys Atk +22, PP +1, Initiative -10.'
        },
        slot3Accessory: {
          bestInSlot: 'Parrying Amulet',
          optimalAlternatives: ['Retaliation Earrings', 'Warrior\'s Medallion', 'Evasion Ring'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Apeliotes\'s Bow', 'Runic Bow', 'Dragonbone Bow'],
          slotType: 'Weapon',
          notes: 'Phys Atk +24, Max HP +20, Guard Rate +10%.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Mercenary\'s Eyepatch',
          optimalAlternatives: ['Sniper\'s Lens', 'Veteran\'s Eyepatch', 'Hunter\'s Cap'],
          slotType: 'Accessory',
          notes: 'Phys Def +1, Critical Rate +20%.'
        },
        slot3Accessory: {
          bestInSlot: 'Veteran\'s Eyepatch',
          optimalAlternatives: ['Mirrored Spectacles', 'Warrior\'s Medallion', 'Sniper\'s Lens'],
          slotType: 'Accessory',
    ...
    tacticsSequence: [
      { step: 1, unit: 'Bertrand', skill: 'Ground Slam', condition1: '[Target: Front Row (2+ Enemies)]', condition2: '[Self AP >= 2]', notes: 'Taunts and stuns enemy frontline.' },
      { step: 2, unit: 'Amalia', skill: 'Penetrate', condition1: '[Target: Column (Armored Priority)]', condition2: '[Self AP >= 2]', notes: 'Pierce through enemy column ignoring armor.' },
      { step: 3, unit: 'Monica', skill: 'Magic Barrier', condition1: '[Before Magic Attack]', condition2: '[Self PP >= 1]', notes: 'Protects Bertrand and Amalia from enemy spells.' },
      { step: 4, unit: 'Aramis', skill: 'Meteor Slash', condition1: '[Target: Lowest HP % Enemy]', condition2: '[Self AP >= 2]', notes: '9-hit physical flurry executing weakened targets.' },
      { step: 5, unit: 'Mandrin', skill: 'Dual Shot', condition1: '[Target: Flying Enemies Priority]', condition2: '[Self AP >= 1]', notes: 'Eliminates aerial scouts with True Strike.' }
    ]
  },

  // ============================================================================
  // SQUAD 9: Bestral Midnight Hunt Pack
  // ============================================================================
  {
    ...
    frontRow: ['dinah-werewolf', 'govil-werewolf'],
    backRow: ['morpan-werebear', 'raenys-featherbow', 'jeremy-landsknecht'],
    keyItems: ['Beastfang Blade', 'Wolfpack Gauntlets', 'Wolf Fang Bracelet', 'Holy Angel Bow'],
    counters: ['Light armored infantry', 'Scouts and evasion units', 'Unshielded casters'],
    strategyGuide: {
    ...
    unitGearConfigs: [
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Carnelian Blade', 'Pursuant\'s Blade', 'Dragonbone Blade'],
          slotType: 'Weapon',
          notes: 'Phys Atk +22, Crit Rate +15%, Initiative +5.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Badger Gauntlets',
          optimalAlternatives: ['Twilight Cloak', 'Evasion Ring', 'Feral Brooch'],
          slotType: 'Accessory',
          notes: 'Initiative +5, Crit Rate +10%, Grants Killing Pursuit.'
        },
        slot3Accessory: {
          bestInSlot: 'Wolfpack Gauntlets',
          optimalAlternatives: ['Warrior\'s Medallion', 'Critical Talisman', 'Predator Ring'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Beastfang Blade', 'Meteorite Sword', 'Dragonbone Blade'],
          slotType: 'Weapon',
          notes: 'Phys Atk +25, AP +1.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Twilight Cloak',
          optimalAlternatives: ['Thief\'s Mantle', 'Silk Scarf', 'Evasion Ring'],
          slotType: 'Accessory',
          notes: 'Evasion +15, Initiative +5, Grants Nocturnal Evade.'
        },
        slot3Accessory: {
          bestInSlot: 'Raven Plume',
          optimalAlternatives: ['Angel Plume', 'Wind Brooch', 'Speed Talisman'],
          slotType: 'Accessory',
          notes: 'Initiative +15 for early turn order.'
        },
        slot4Accessory: {
          bestInSlot: 'Lapis Pendant',
          optimalAlternatives: ['Sapphire Pendant', 'Power Belt', 'Critical Talisman'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Boreas\'s Axe', 'Dragonbone Axe', 'Carnelian Axe'],
          slotType: 'Weapon',
          notes: 'Phys Atk +24, Max HP +20.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Ironclad Buckler',
          optimalAlternatives: ['Beast Hunter\'s Buckler', 'Unyielding Shield', 'Steel Shield'],
          slotType: 'Shield',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Apeliotes\'s Bow', 'Zenoiran Bow', 'Runic Bow'],
          slotType: 'Weapon',
          notes: 'Phys Atk +24, Mag Atk +18, Blindness Affliction +20%.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Silken Scarf',
          optimalAlternatives: ['Angel Plume', 'Silk Hood', 'Feather Plume'],
          slotType: 'Accessory',
          notes: 'Phys Def +1, Evasion +20.'
        },
        slot3Accessory: {
          bestInSlot: 'Raven Plume',
          optimalAlternatives: ['Wind Brooch', 'Speed Belt', 'Celestial Talisman'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Kingsblade Cornix', 'Notos\'s Sword', 'Dragonbone Sword'],
          slotType: 'Weapon',
          notes: 'Phys Atk +26, Crit Rate +10%, AP +1 on Kill.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Mercenary\'s Shield',
          optimalAlternatives: ['Steel Shield', 'Chivalric Shield', 'Parrying Shield'],
          slotType: 'Shield',
        ...
        slot4Accessory: {
          bestInSlot: 'Power Belt',
          optimalAlternatives: ['Warrior\'s Medallion', 'Armored Gauntlets', 'Vitality Talisman'],
          slotType: 'Accessory',
          notes: 'Phys Atk +1, Grants Toughness, Max HP +10.'
        }
      }
    ...
    tacticsSequence: [
      { step: 1, unit: 'Raenys', skill: 'Shining Arrow', condition1: '[Start of Battle]', condition2: '[Target: Enemy Front Row]', notes: 'Turn-0 blindness rendering enemy physical attackers useless.' },
      { step: 2, unit: 'Dinah', skill: 'Piercing Claw', condition1: '[Target: Armored Enemy]', condition2: '[Self AP >= 1]', notes: 'Shreds enemy physical defense by 50%.' },
      { step: 3, unit: 'Govil', skill: 'Chasing Slash', condition1: '[After Ally Attacks]', condition2: '[Self PP >= 1]', notes: 'Follow-up strike against bleeding and weakened targets.' },
      { step: 4, unit: 'Jeremy', skill: 'Killing Chain', condition1: '[Target: Lowest HP % Enemy]', condition2: '[Self AP >= 1]', notes: 'Executes targets and restores +1 AP on kill.' },
      { step: 5, unit: 'Morpan', skill: 'Heavy Cover', condition1: '[Before Ally Attacked (Back Row)]', condition2: '[Self PP >= 1]', notes: 'Guards backline shooters from enemy retaliations.' }
    ]
  },

  // ============================================================================
  // SQUAD 10: Sanatio Divine Sacred Zenith & Magic Reflection
  // ============================================================================
  {
    ...
    frontRow: ['ochlys-feathersword', 'umerus-feathersword'],
    backRow: ['sanatio-featherstaff', 'tatiana-bishop', 'gloucester-doom-knight'],
    keyItems: ['Kingstaff Albiore', 'Heavenswing Shield', 'Monk\'s Mitre', 'Wingcrest Shield'],
    counters: ['Trinity Rain / Magic Nuke squads', 'Low accuracy melee compositions'],
    strategyGuide: {
    ...
    unitGearConfigs: [
      {
        ...
        slot2ShieldOrOffhand: {
          ...
          optimalAlternatives: ['Silk Hood', 'Sage\'s Hood', 'Saint\'s Mitre'],
          slotType: 'Accessory',
          notes: 'Phys Def +1, Mag Def +1, Grants Quick Heal.'
        },
        slot3Accessory: {
          bestInSlot: 'Holy Broach',
          optimalAlternatives: ['Sacral Broach', 'Rose Broach', 'Leaf Broach'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Notos\'s Sword', 'Hallowed Blade', 'Meteorite Sword'],
          slotType: 'Weapon',
          notes: 'Phys Atk +24, Initiative +8, Evasion +15.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Heavenswing Shield',
          optimalAlternatives: ['Wingcrest Shield', 'Azure Crest Shield', 'Steel Shield'],
          slotType: 'Shield',
          notes: 'Phys Def +5, Accuracy +10, Evasion +10, Magic Reflect.'
        },
        slot3Accessory: {
          bestInSlot: 'Lucky Coin',
          optimalAlternatives: ['Silken Scarf', 'Evasion Ring', 'Wind Brooch'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Zephyrus Sword', 'Notos\'s Sword', 'Meteorite Sword'],
          slotType: 'Weapon',
          notes: 'Phys Atk +24, HP Regen +10%.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Wingcrest Shield',
          optimalAlternatives: ['Heavenswing Shield', 'Chivalric Shield', 'Steel Shield'],
          slotType: 'Shield',
          notes: 'Phys Def +7, Base PP +1, Critical Rate -20%.'
        },
        slot3Accessory: {
          bestInSlot: 'Shawl of Repose',
          optimalAlternatives: ['Silken Scarf', 'Angel Plume', 'Evasion Ring'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Hallowed Staff', 'Euros\'s Staff', 'Cleric\'s Cane'],
          slotType: 'Weapon',
          notes: 'Mag Atk +25, Affliction Immunity, Heal 20% HP on active action.'
        },
        slot2ShieldOrOffhand: {
          bestInSlot: 'Silk Hood',
          optimalAlternatives: ['Archbishop\'s Mitre', 'Saint\'s Hood', 'Magick Brooch'],
          slotType: 'Accessory',
          notes: 'Mag Def +4, Initiative +3.'
        },
        slot3Accessory: {
          bestInSlot: 'First Aid Kit',
          optimalAlternatives: ['Celestial Talisman', 'Healing Brooch', 'Saint\'s Talisman'],
          slotType: 'Accessory',
      ...
      },
      {
        ...
        slot1Weapon: {
          ...
          optimalAlternatives: ['Carnelian Spear', 'Dragonbone Spear', 'Meteorite Lance'],
          slotType: 'Weapon',
        ...
        slot4Accessory: {
          bestInSlot: 'Power Belt',
          optimalAlternatives: ['Warrior\'s Medallion', 'Vitality Talisman', 'Critical Talisman'],
          slotType: 'Accessory',
    ...
    tacticsSequence: [
      { step: 1, unit: 'Sanatio', skill: 'Sacred Barrier', condition1: '[Start of Battle]', condition2: '[Self PP >= 1]', notes: 'Grants 2-hit absolute damage nullification barrier to entire squad.' },
      { step: 2, unit: 'Ochlys', skill: 'Spiral Sword', condition1: '[Target: Front Row (2+ Enemies)]', condition2: '[Self AP >= 2]', notes: 'Aerial row strike dealing heavy physical damage.' },
      { step: 3, unit: 'Gloucester', skill: 'Dark Flame', condition1: '[Target: Enemy Row]', condition2: '[Self AP >= 2]', notes: 'Unleashes dark magical flame afflicting targets with Burn.' },
      { step: 4, unit: 'Tatiana', skill: 'Row Heal', condition1: '[Ally HP <= 50%]', condition2: '[Self AP >= 1]', notes: 'Restores critical squad health across entire row.' },
      { step: 5, unit: 'Umerus', skill: 'Aerial Guard', condition1: '[Before Being Attacked]', condition2: '[Self PP >= 1]', notes: 'Evades incoming ground attacks with aerial mobility.' }
    ]
  }
];

const fileContent = `import { SquadBuild } from '@/types';\n\nexport const ZERO_OVERLAP_SQUADS: SquadBuild[] = ${JSON.stringify(ZERO_OVERLAP_SQUADS, null, 2)};\n`;

fs.writeFileSync(squadsFile, fileContent, 'utf8');
console.log('Successfully written pristine ZERO_OVERLAP_SQUADS with Dual-Shield Virginia & updated squad loadouts!');
