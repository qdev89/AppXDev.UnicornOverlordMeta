...
console.log('=== BUILDING COMPREHENSIVE AUTHENTIC GAME DATA ===');

// All 425 official items
const officialItems = JSON.parse(fs.readFileSync('./scripts/official_items_extracted.json', 'utf8'));

// Complete authentic classes with verified in-game skills
const COMPLETE_CLASSES = [
  ...
  },
  {
    ...
    recommendedEquipment: ["Icefall Bow", "White Cat-Ear Hood", "Sniper's Amber Lens", "Carnelian Pendant"],
...
fs.writeFileSync('./src/data/classes.ts', `import { UnitClass } from '@/types';\n\nexport const CLASSES_DATA: UnitClass[] = ${JSON.stringify(COMPLETE_CLASSES, null, 2)};\n`);
console.log('Successfully written authentic CLASSES_DATA!');
