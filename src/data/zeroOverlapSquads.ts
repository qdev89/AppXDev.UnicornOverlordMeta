...
export const ZERO_OVERLAP_SQUADS: SquadBuild[] = [
    ...
    unitGearConfigs: [
      {
        ...
        weapon: 'Millennium Scepter (Trinity Rain 4 AP)',
      ...
      },
      {
        ...
        weapon: 'Hallow Staff',
        shieldOrHelm: 'Cat-Ear Hood (Quick Impetus: +100% Turn Bar to Ally)',
      ...
      },
      {
        ...
        accessory1: 'Familiar\'s Choker (Sorcerous Connection: +50% Mag Atk)',
  ...
  },
  {
    ...
    description: 'Alain leads a heavy frontline blitz. Rosalinde locks down enemy vanguards at battle start with Rage of the Faeries (Row Stun), Chloe grants guaranteed critical hits via Keen Call, and Renault crushes armor line after line.',
    ...
    unitGearConfigs: [
      {
        ...
        accessory1: 'Ring of the Maiden (Affliction Immunity + All Stats)',
        accessory2: 'Carnelian Pendant (+1 AP)',
      ...
      },
      {
        ...
        roleTitle: 'Crit Enabler & Support Spear',
        weapon: 'Hero\'s Spear',
        shieldOrHelm: 'Sergeant\'s Shield',
        accessory1: 'Keen Earring (Keen Call: 100% Crit to Alain)',
        accessory2: 'Lapis Pendant (+1 PP)',
  ...
  },
  {
    ...
    description: 'Hilda delivers a devastating Dragoon Dive aerial bomb (4 AP). Eltolinde channels Tailwind Array (+20 Squad Initiative) at battle start, while Celeste pulls flying backliners and Miriam provides magic protection.',
    keyItems: ['Dragoon\'s War Spear', 'Angel Plume', 'Glacial Staff', 'White Cat-Ear Cap'],
    ...
    strategyGuide: {
      ...
      overview: 'Eltolinde starts battle with Tailwind Array. Hilda uses Dragoon Dive (4 AP aerial charge). Primm uses White Cat-Ear Cap (Quick Impetus) to immediately fire the dive. Angel Plume grants +20 Initiative to the squad. Celeste pulls backline units with Aerial Sweeper.',
      combatSequenceNotes: [
        'Turn 0: Eltolinde triggers Tailwind Array -> Grants +20 Squad Initiative.',
    ...
    unitGearConfigs: [
      {
        ...
        weapon: 'Dragoon\'s War Spear (Dragoon Dive 4 AP)',
      ...
      },
      {
        ...
        accessory1: 'Angel Plume (Tailwind Array: +20 Squad Initiative)',
        accessory2: 'Lapis Pendant (+1 PP)',
        statPriorities: ['Initiative (S+)', 'Mag Atk (A)'],
        growthTypes: ['Speedster', 'Speedster']
      },
  ...
  },
  {
    ...
    description: 'Berengaria exploits enemy afflictions. Travis opens with row-wide Blindness via Shadowbite, triggering Berengaria\'s Eye of the Crimson Bear (-20% Atk/Def) and Sanguine Pursuit to perpetually freeze enemy turns.',
    ...
    unitGearConfigs: [
      {
        ...
        accessory1: 'Executioner\'s Eye (Pursuit Crit)',
        accessory2: 'Carnelian Pendant (+1 AP)',
      ...
      },
      {
        ...
        accessory1: 'Phantom Ring (Shadowbite: Row Blindness)',
        accessory2: 'Raven Plume (+15 Initiative)',
  ...
  },
  {
    ...
    description: 'Virginia anchors a counter-attack fortress. Gilbert buffs Initiative and Attack on Turn 0 with Offensive Order, allowing Virginia (dual-wielding swords), Melisandre, and Leah to punish every enemy swing with lethal parries.',
    ...
    unitGearConfigs: [
      {
        ...
        roleTitle: 'Dual-Sword Counter Tank',
        weapon: 'Maiden\'s Sword',
        shieldOrHelm: 'Rose Shield',
        accessory1: 'Counter Earring (Retaliation Counter)',
        accessory2: 'Carnelian Pendant (+1 AP)',
      ...
      },
      {
        ...
        shieldOrHelm: 'Duelling Saber',
        accessory1: 'Parrying Ring (Parrying Slash)',
        accessory2: 'Lapis Pendant (+1 PP)',
  ...
  },
  {
    ...
    description: 'Yunifi freezes the entire enemy force on Turn 1 with Glacial Rain (4 AP). Ramona (Wereowl) refills squad PP with Owl Eyes, while Ridiel cleanses incoming debuffs with Pure Light and Bryce holds an unbreachable wall.',
    ...
    unitGearConfigs: [
      {
        ...
        weapon: 'Glacial Bow (Glacial Rain 4 AP)',
      ...
      },
      {
        ...
        shieldOrHelm: 'Elven Crown',
        accessory1: 'Pure Light Amulet (Pure Light Row Cleanse)',
        accessory2: 'Lapis Pendant (+1 PP)',
  ...
  },
  {
    ...
    description: 'Amalia channels massive armor-ignoring slash damage with Grand Crusher Greatsword. Bertrand taunts physical threats with Indomitable Guard, Aramis shreds squishies, and Monica provides magical shielding.',
    ...
    unitGearConfigs: [
      {
        ...
        roleTitle: 'Colossal Greatsword Striker',
  ...
  },
  {
    ...
    description: 'Dinah and Govil unleash Bestral Night ferocity. Night Vision Ring grants +20% stats during night battles, Govil pierces row defenses with Shadow Pierce, and Raenys blinds frontliners at battle start.',
  ...
  },
  {
    ...
    description: 'Sanatio protects the squad with Sacred Barrier on Turn 0 (2 hit nullification barrier to squad). Umerus counters aerial/melee attacks with evasive thrusts, while Scarlett and Tatiana maintain 100% squad health.',
